...
@Operation(
    id = AddTranspositionDirective.ID,
    category = Constants.CAT_DOCUMENT,
    label = "Add Transposition Directive",
    description = "Add Transposition Directive"
)
        ...
        try {
            if (numero == null || "".equals(numero.trim())) {
                ...
                TranspositionDirective transpositionDirective = SolonEpgServiceLocator
                    ...
                    .findOrCreateTranspositionDirective(session, numero);
                ...
                ActiviteNormative activiteNormative = transpositionDirective
                    .getDocument()
