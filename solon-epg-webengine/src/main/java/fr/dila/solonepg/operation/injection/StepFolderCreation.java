...
@Operation(
    id = StepFolderCreation.ID,
    category = Constants.CAT_DOCUMENT,
    label = "Create Step Folder",
    description = "Create Step Folder ."
)
public class StepFolderCreation {
    ...
    public DocumentModel run() throws Exception {
        ...
        try {
            stepFolder =
                session.createDocumentModel(parentPath, name, FeuilleRouteConstant.TYPE_FEUILLE_ROUTE_STEP_FOLDER);
