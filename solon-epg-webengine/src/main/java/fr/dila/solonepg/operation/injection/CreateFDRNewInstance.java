...
@Operation(
    id = CreateFDRNewInstance.ID,
    category = Constants.CAT_DOCUMENT,
    label = "Create new FDR Instance",
    description = "Create w FDR Instance ."
)
public class CreateFDRNewInstance {
    ...
    public DocumentModel run() throws Exception {
        ...
        try {
            ...
            SSFeuilleRoute stRouteInstance = routeInstance.getAdapter(SSFeuilleRoute.class);
