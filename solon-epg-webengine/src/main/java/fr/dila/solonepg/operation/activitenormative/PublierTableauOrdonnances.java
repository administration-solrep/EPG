...
@Operation(
    id = PublierTableauOrdonnances.ID,
    category = Constants.CAT_DOCUMENT,
    label = "Publier Tableau Des Ordonnances",
    description = "Publier Tableau Des Ordonnances"
)
public class PublierTableauOrdonnances {
    ...
    public void run() throws Exception {
        ...
        List<DocumentModel> documentModelList = SolonEpgServiceLocator
            ...
            .getAllActiviteNormative(session, ActiviteNormativeEnum.APPLICATION_DES_ORDONNANCES.getId(), true);
