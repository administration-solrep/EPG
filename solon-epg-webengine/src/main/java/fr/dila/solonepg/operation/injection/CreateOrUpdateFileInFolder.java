...
@Operation(
    id = CreateOrUpdateFileInFolder.ID,
...
public class CreateOrUpdateFileInFolder {
    ...
    @OperationMethod
    public DocumentModel run(final Blob blob) {
        ...
        try {
            ...
            result =
                treeService.createOrUpdateFileInFolder(
                    documentId,
                    blob,
                    session,
                    documentType,
            ...
            throw new NuxeoException("Erreur lors de l'upload de fichier " + fileName, e);
        }
        return result;
    }
}
