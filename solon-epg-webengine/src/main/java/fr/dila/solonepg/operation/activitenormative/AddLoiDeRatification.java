...
@Operation(
    id = AddLoiDeRatification.ID,
    category = Constants.CAT_DOCUMENT,
    label = "Add Loi De Ratification",
    description = "Add Loi De Ratification"
)
    ...
    public void run(DocumentModel doc) throws Exception {
        ...
        try {
            ...
            SolonEpgServiceLocator
                ...
                .saveProjetsLoiDeRatificationReprise(loiDeRatification, session, activiteNormative);
