...
public interface ActeService extends Serializable {
    ...
    Set<String> getDecretList();

    Set<String> getOrdonanceList();
    ...
    /**
     * Test si le type d'acte correspond à un chemin de croix
     *
     * @param typeActe
     * @return
     */
    boolean isCheminDeCroix(String typeActe);
    ...
    /**
     * Test si le type d'acte correspond a un type reglementaire
     *
     * @param typeActe
     * @return
     */
    boolean isReglementaire(String typeActe);
