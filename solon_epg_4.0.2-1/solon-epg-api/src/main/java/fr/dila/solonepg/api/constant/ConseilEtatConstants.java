...
public final class ConseilEtatConstants {
    ...
    public static final String CONSEIL_ETAT_SECTION_CE_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_SECTION_CE_PROPERTY;

    public static final String CONSEIL_ETAT_RAPPORTEUR_CE_PROPERTY = "rapporteurCe";
    public static final String CONSEIL_ETAT_RAPPORTEUR_CE_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_RAPPORTEUR_CE_PROPERTY;

    public static final String CONSEIL_ETAT_DATE_TRANSMISSION_SECTION_CE_PROPERTY = "dateTransmissionSectionCe";
    public static final String CONSEIL_ETAT_DATE_TRANSMISSION_SECTION_CE_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_DATE_TRANSMISSION_SECTION_CE_PROPERTY;

    public static final String CONSEIL_ETAT_DATE_SECTION_CE_PROPERTY = "dateSectionCe";
    public static final String CONSEIL_ETAT_DATE_SECTION_CE_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_DATE_SECTION_CE_PROPERTY;

    public static final String CONSEIL_ETAT_DATE_AG_CE_PROPERTY = "dateAgCe";
    public static final String CONSEIL_ETAT_DATE_AG_CE_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_DATE_AG_CE_PROPERTY;

    public static final String CONSEIL_ETAT_NUMERO_ISA_PROPERTY = "numeroISA";
    public static final String CONSEIL_ETAT_NUMERO_ISA_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_NUMERO_ISA_PROPERTY;
    ...
    public static final String CONSEIL_ETAT_PRIORITE_XPATH =
        CONSEIL_ETAT_SCHEMA_PREFIX + ":" + CONSEIL_ETAT_PRIORITE_PROPERTY;
    ...
    public static final List<String> sectionConseilEtatList = Collections.unmodifiableList(
        Arrays.asList(
            CONSEIL_ETAT_SECTION_CE,
            CONSEIL_ETAT_SECTION_ADMINISTRATION,
            CONSEIL_ETAT_SECTION_INTERIEUR,
            CONSEIL_ETAT_SECTION_FINANCE,
            CONSEIL_ETAT_SECTION_TP,
            CONSEIL_ETAT_SECTION_SOCIALE,
    ...
    public static final List<String> sectionConseilEtatListShort = Collections.unmodifiableList(
        Arrays.asList(
            CONSEIL_ETAT_SECTION_CE_SHORT,
            CONSEIL_ETAT_SECTION_ADMINISTRATION_SHORT,
            CONSEIL_ETAT_SECTION_INTERIEUR_SHORT,
            CONSEIL_ETAT_SECTION_FINANCE_SHORT,
            CONSEIL_ETAT_SECTION_TP_SHORT,
