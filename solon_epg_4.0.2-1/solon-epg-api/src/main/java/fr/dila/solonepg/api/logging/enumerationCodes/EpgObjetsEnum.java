 ...
 * 234 : WS EPP <br />
 * 235 : Squelette <br />
 * 236 : Operation checkParapkeurComplet <br />
 * 237 : Operation dossierDoneToRunning <br />
 *
 * 276 : Batch lanceur général divers <br />
 * 277 : Batch lanceur général alert <br />
 * 278 : Batch lanceur général PAN et statistiques <br />
 * 279 : Batch retour VITAM <br />
 * 280 : Batch d'extraction Adamant <br />
...
public enum EpgObjetsEnum implements STCodes {
     ...
     * 235 : Squelette
     */
    SQUELETTE(235, "Squelette"),
    /*
     * 236 : Operation dossierDoneToRunning
     */
    OPERATION_CHECK_PARAPHEUR_COMPLET(236, "operation checkParapheurComplet"),

    // ******************************BATCHS

    /* **** Rajouter vos batchs ici, en ordre décroissant. **** */
    /**
     * /*** 276 : Batch de mise à jour des questions connexes
     */
    BATCH_LANCEUR_GENERAL_DIVERS(277, "Batch lanceur général divers"),
    /**
     * /*** 277 : Batch de mise à jour des questions connexes
     */
    BATCH_LANCEUR_GENERAL_ALERT(278, "Batch lanceur général alert"),
    /**
     * /*** 278 : Batch de mise à jour des questions connexes
     */
    BATCH_LANCEUR_GENERAL_PAN(279, "Batch lanceur général PAN et statistique"),

    /**
     * 279 : Batch retour VITAM
     */
    BATCH_RETOUR_VITAM(279, "Batch retour VITAM"),
    /**
     ...
     * 301 : PAN (défaut)
     */
    PAN(301, "Espace Activité Normative"),
    /**
     * 302 : Elastic search
     */
    ELASTIC_SEARCH(201, "Elastic search");
