...
public class SolonEpgBaseFunctionConstant {
     ...
     */
    public static final String ADMIN_FONCTIONNEL_TABLEAU_DYNAMIQUE_DESINATAIRE_VIEWER =
     ...
     * MGPP
     */
    public static final String RESPONSABLE_MGPP = "Responsable MGPP";

    /**
     * Donne le droit de saisine rectificative et d'envoi de pièces complémentaires pour le Conseil d'Etat
     */
    public static final String CONSEIL_ETAT_ENVOI_SAISINE_PIECE_COMPLEMENTAIRE_EXECUTOR =
        "EnvoiSaisinePieceComplementaireExecutor";

    /*********************************************
     * Droit de l'espace d'activite normative
     *********************************************/
    public static final String ESPACE_ACTIVITE_NORMATIVE_APPLICATION_LOIS_READER =
        "EspaceActiviteNormativeAppLoisReader";
    public static final String ESPACE_ACTIVITE_NORMATIVE_APPLICATION_ORDONNANCES_READER =
    ...
    public static final String ESPACE_ACTIVITE_NORMATIVE_TRANSPOSITION_READER =
        "EspaceActiviteNormativeTranspositionReader";
    public static final String ESPACE_ACTIVITE_NORMATIVE_APPLICATION_LOIS_UPDATER =
        "EspaceActiviteNormativeAppLoisUpdater";
    public static final String ESPACE_ACTIVITE_NORMATIVE_APPLICATION_ORDONNANCES_UPDATER =
    ...
    public static final String ESPACE_ACTIVITE_NORMATIVE_TRANSPOSITION_UPDATER =
        "EspaceActiviteNormativeTranspositionUpdater";
    public static final String ESPACE_ACTIVITE_NORMATIVE_EXPORT_DATA_UPDATER =
        "EspaceActiviteNormativeExportDataUpdater";
    public static final String ESPACE_ACTIVITE_NORMATIVE_PARAM_LEGIS_UPDATER =
        "EspaceActiviteNormativeParamLegisUpdater";
    public static final String ESPACE_ACTIVITE_NORMATIVE_PUBLI_LEGIS_EXEC =
        "EspaceActiviteNormativePublicationExecutor";
    public static final String ESPACE_ACTIVITE_NORMATIVE_APP_LOI_MINISTERE =
        "EspaceActiviteNormativeMinistereApplicationLoi";
    public static final String ESPACE_ACTIVITE_NORMATIVE_APP_ORDONNANCE_MINISTERE =
    ...
    /**
     * Donne le droit de terminer un dossier
     */
    public static final String DOSSIER_ENDER = "DossierEnder";

    /**
     * Donne le droit de modifier le type d'acte au sein des dossiers de type arrêtés
     */
    public static final String DOSSIER_TYPE_ACTE_ARRETE_UPDATER = "DossierTypeActeArreteUpdater";

    /**
     * Donne le droit de réaliser des actions spécifiques des mesures nominatives
     */
    public static final String DOSSIER_MESURE_NOMINATIVES_UPDATER = "DossierMesureNominativeUpdater";
