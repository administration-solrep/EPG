...
public final class SolonEpgParapheurConstants extends SSParapheurConstants {
     ...
     */
    public static final String PARAPHEUR_ERROR_MSG_EXCEPTION_THROW =
        "Le titre et la date de signature n'ont pas pu être reportés dans le bordereau du dossier";
     ...
     */
    public static final String PARAPHEUR_ERROR_MSG_DATE_BAD_FORMAT =
        "La date de signature n'a pas pu être reportée dans le bordereau du dossier";

    /**
     * message signalant que le titre de l'acte est nul et n'as pas pu être reportée dans le bordereau du dossier
     */
    public static final String PARAPHEUR_ERROR_MSG_TITRE_ACTE_NOT_FOUND =
        "Le titre de l'acte n'a pas pu être reporté dans le bordereau du dossier";
    ...
    /**
     * Nombre de document accepté dans le répertoire épreuvage
     */
    public static final long NB_DOC_MAX_REP_EPREUVE = 2L;
