...
public class VocabularyConstants {
    ...
    /**
     * Vocabulaire législature
     */
    public static final String LEGISLATURE_DIRECTORY = "legislature";
    public static final String LEGISLATURE_VOCABULARY_SCHEMA = "vocabularyLegislature";

    /**
     * Vocabulaire vecteur publication textes signalés
     */
    public static final String VECTEUR_PUBLICATION_TS = "vecteur_publication_ts";
     ...
     */
    public static final long ARCHIVE_AUCUN_ET_CANDIDAT_INTERMEDIAIRE = 0;

    /**
     * Champ d'optimisation : archive intermédiaire et candidat archivage définitif
     */
    public static final long ARCHIVE_INTERMEDIAIRE_ET_CANDIDAT_DEFINITIF = 1;

    /**
     * Libelle du statut d'archivage candidat a l'archivage intermédiaire
     */
    public static final String LABEL_STATUT_ARCHIVAGE_CANDIDAT_BASE_INTERMEDIAIRE =
        "Dossier candidat à l'archivage intermédiaire";
     ...
     */
    public static final String LABEL_STATUT_ARCHIVAGE_CANDIDAT_BASE_DEFINITIVE =
        "Dossier candidat à l'archivage définitif";
     ...
     */
    public static final Map<String, String> LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID = new HashMap<>();

    static {
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_CANDIDAT_BASE_INTERMEDIAIRE,
            LABEL_STATUT_ARCHIVAGE_CANDIDAT_BASE_INTERMEDIAIRE
        ); // statut 2
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_BASE_INTERMEDIAIRE,
            LABEL_STATUT_ARCHIVAGE_BASE_INTERMEDIAIRE
        ); // statut 3
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_CANDIDAT_BASE_DEFINITIVE,
            LABEL_STATUT_ARCHIVAGE_CANDIDAT_BASE_DEFINITIVE
        ); // statut 4
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_EXTRACTION_EN_COURS,
            LABEL_STATUT_ARCHIVAGE_EXTRACTION_EN_COURS
        ); // statut 5
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_DOSSIER_GENERE,
            LABEL_STATUT_ARCHIVAGE_DOSSIER_GENERE
        ); // statut 6
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(STATUT_ARCHIVAGE_DOSSIER_LIVRE, LABEL_STATUT_ARCHIVAGE_DOSSIER_LIVRE); // statut 7
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_DOSSIER_ARCHIVE,
            LABEL_STATUT_ARCHIVAGE_DOSSIER_ARCHIVE
        ); // statut 8
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_DOSSIER_ERREUR_GEN_SIP,
            LABEL_STATUT_ARCHIVAGE_ERREUR_GEN_SIP
        ); // statut 90
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_DOSSIER_ERREUR_LIVRAISON,
            LABEL_STATUT_ARCHIVAGE_ERREUR_LIVRAISON
        ); // statut 91
        LIST_LIBELLE_STATUT_ARCHIVAGE_PAR_ID.put(
            STATUT_ARCHIVAGE_DOSSIER_ERREUR_ARCHIVAGE,
            LABEL_STATUT_ARCHIVAGE_ERREUR_ARCHIVAGE
        ); // statut 92
    }
     ...
     */
    public static final List<String> STATUT_ARCHIVAGE_INITIAL_FACET = new ArrayList<>();
    ...
    public static final String TYPE_PUBLICATION_INTEGRAL = "1";
    ...
    public static final String VOCABULARY_STATUS_ARCHIVAGE = "status_archivage";
    ...
    public static final List<String> LIST_MESURE_STATS = new ArrayList<>();
    ...
    public static final String TYPE_SIGNATAIRE_TP_PR = "1";
    public static final String TYPE_SIGNATAIRE_TP_PM = "2";
    public static final String TYPE_SIGNATAIRE_TP_SGG = "3";
    public static final String TYPE_SIGNATAIRE_TP_AUCUN = "4";
    ...
    /**
     * Vocabulaire priorite_ce.
     */
    public static final String NIVEAU_PRIORITE_CE_DIRECTORY_NAME = "priorite_ce";
    ...
    public static final String RESPONSABLE_AMENDEMENT_DIRECTORY = "responsable_amendement";
    public static final String POLE_CHARGE_MISSION_DIRECTORY = "charge_mission";
    /**
    ...
    public static final long FILETYPEID_ACTE = 1;
    public static final long FILETYPEID_EXTRAIT = 2;
    public static final long FILETYPEID_AUTREPARAPHEUR = 3;
    public static final long FILETYPEID_FONDDOSSIER = 4;
    ...
    /**
     * Vocabulaire de statut de validation
     */
    public static final String STATUT_VALIDATION_DIRECTORY_NAME = "statut_validation";

    /**
     * Vocabulaire nature texte base legale
     */
    public static final String BASE_LEGALE_NATURE_TEXTE_DIRECTORY_NAME = "base_legale_nature_texte";

    /**
     * Vocabulaire disposition habilitation / fondement constitutionnel
     */
    public static final String DISPOSITION_HABILITATION_DIRECTORY_NAME = "disposition_habilitation";

    /**
     * Vocabulaire périodicité du rapport
     */
    public static final String PERIODICITE_RAPPORT_DIRECTORY_NAME = "periodicite_rapport";

    public static final String PERIODICITE_RAPPORT_APPLICATION_LOI_VALUE = "RAPPORT_RELATIF_ARTICLE_67_LOI_N_2004-1343";
}
