...
public class SolonEpgViewConstant {
     ...
     * Espace de suivi : Statistiques
     */
    public static final String ESPACE_SUIVI_STATISTIQUES_CONTENT_VIEW_DOSSIER_ARCHIVE =
     ...
     *
     */
    public static final String ADMIN_MINISTERIEL_SUPPRESSION_CONTENET =
        "admin_ministrielle_suppression_dossier_content";
     ...
     */
    public static final String ADMIN_MODELE_FEUILLE_ROUTE_MASS_SUBSTITUER_POSTE =
        "admin_modele_feuille_route_mass_substituer_poste";
     ...
     * Espace suivi  Infocentre SGG
     */
    public static final String ESPACE_SUIVI_INFOCENTRE_SGG_TEXTE_SIGNALE =
        "view_espace_suivi_infocentre_sgg_texte_signale";
     ...
     */
    public static final String REQUETEUR_DOSSIER_SIMPLE_FAVORIS_RESULTATS =
        "requeteur_dossier_simple_resultats_favoris";
     ...
     */
    public static final String ESPACE_RECHERCHE_FAVORIS_CONSULTATIONS_DOSSIER_VIEW =
        ESPACE_RECHERCHE_FAVORIS_CONSULTATIONS_VIEW + "_dossier";

    /**
     * Liste des favoris de consultation des feuilles de route.
     */
    public static final String ESPACE_RECHERCHE_FAVORIS_CONSULTATIONS_FDR_VIEW =
        ESPACE_RECHERCHE_FAVORIS_CONSULTATIONS_VIEW + "_fdr";

    /**
     * Liste des favoris de consultation des utilisateurs.
     */
    public static final String ESPACE_RECHERCHE_FAVORIS_CONSULTATIONS_USER_VIEW =
        ESPACE_RECHERCHE_FAVORIS_CONSULTATIONS_VIEW + "_user";
     ...
     */
    public static final String ESPACE_RECHERCHE_UTILISATEUR_RESULTATS_CONSULTES =
        "view_recherche_resultats_consultes_user";
     ...
     */
    public static final String ESPACE_RECHERCHE_UTILISATEUR_FAVORIS_CONSULTATIONS =
        "view_recherche_favoris_consultations_user";
