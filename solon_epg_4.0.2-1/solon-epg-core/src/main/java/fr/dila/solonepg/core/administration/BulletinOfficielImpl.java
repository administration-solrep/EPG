...
public class BulletinOfficielImpl extends STDomainObjectImpl implements BulletinOfficiel {
    ...
    public String getNor() {
        return getStringProperty(
            ...
            SolonEpgBulletinOfficielConstants.BULLETIN_OFFICIEL_NOR
        );
    }
    ...
    public String getIntitule() {
        return getStringProperty(
            SolonEpgBulletinOfficielConstants.BULLETIN_OFFICIEL_SCHEMA,
            SolonEpgBulletinOfficielConstants.BULLETIN_OFFICIEL_INTITULE
        );
    }
    ...
    public String getEtat() {
        return getStringProperty(
            SolonEpgBulletinOfficielConstants.BULLETIN_OFFICIEL_SCHEMA,
            SolonEpgBulletinOfficielConstants.BULLETIN_OFFICIEL_ETAT
        );
    }
