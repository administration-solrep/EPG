...
public class VecteurPublicationImpl extends STDomainObjectImpl implements VecteurPublication {
    ...
    public String getIntitule() {
        return getStringProperty(
            ...
            SolonEpgVecteurPublicationConstants.VECTEUR_PUBLICATION_INTITULE
        );
    }
    ...
    public Calendar getDateDebut() {
        return getDateProperty(
            SolonEpgVecteurPublicationConstants.VECTEUR_PUBLICATION_SCHEMA,
            SolonEpgVecteurPublicationConstants.VECTEUR_PUBLICATION_DEBUT
        );
    }
    ...
    public Calendar getDateFin() {
        return getDateProperty(
            SolonEpgVecteurPublicationConstants.VECTEUR_PUBLICATION_SCHEMA,
            SolonEpgVecteurPublicationConstants.VECTEUR_PUBLICATION_FIN
        );
    }
