...
public class DossierImpl extends STDossierImpl implements Dossier {
    ...
    protected List<ComplexeType> getTranspositionProperty(String schema, String value) {
        return PropertyHelper.getListSerializableProperty(document, schema, value);
    }
    ...
    @Override
    public DocumentModel getDossierMetadata(Dossier dossier) {
    ...
    /**
     * Copie tous les propriété du schéma d'un documentModel donné dans un autre
     * documentModel
     *
     * @param src
     * @param dst
     * @param schema
     */
    private void copySchema(DocumentModel src, DocumentModel dst, String schema) {
        dst.setProperties(schema, src.getProperties(schema));
    }
    ...
    public String getStatutLabel() {
        return PropertyUtil.getStringProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_STATUT_LABEL_PROPERTY
        );
    }
    ...
    public String getTypeActeLabel() {
        return PropertyUtil.getStringProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_TYPE_ACTE_LABEL_PROPERTY
        );
    }
    ...
    @Override
    public String getCategorieActeLabel() {
        return PropertyUtil.getStringProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_CATEGORIE_ACTE_LABEL_PROPERTY
        );
    }

    @Override
    public void setCategorieActeLabel(String categorieActe) {
        setProperty(
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_CATEGORIE_ACTE_LABEL_PROPERTY,
            categorieActe
    ...
    public List<String> getPublicationsConjointesUnrestricted(CoreSession session) {
        ...
        try {
            publicationsConjointes =
                (List<String>) new UnrestrictedGetOrSetPropertyDocumentRunner(session, document)
                .getProperty(
                        DossierSolonEpgConstants.DOSSIER_SCHEMA,
                        DossierSolonEpgConstants.DOSSIER_PUBLICATION_CONJOINTE_PROPERTY
                    );
        } catch (NuxeoException e) {
            throw new NuxeoException("Erreur lors de de la récupération des publicationsConjointes", e);
        }
    ...
    public void setPublicationsConjointesUnrestricted(CoreSession session, List<String> publicationsConjointes) {
        try {
            new UnrestrictedGetOrSetPropertyDocumentRunner(session, document)
            .setProperty(
                    DossierSolonEpgConstants.DOSSIER_SCHEMA,
                    DossierSolonEpgConstants.DOSSIER_PUBLICATION_CONJOINTE_PROPERTY,
                    publicationsConjointes
    ...
    @Override
    public String getPublicationIntegraleOuExtraitLabel() {
        return PropertyUtil.getStringProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_PUBLICATION_INTEGRALE_OU_EXTRAIT_LABEL_PROPERTY
        );
    }

    @Override
    public void setPublicationIntegraleOuExtraitLabel(String publicationIntegraleOuExtrait) {
        setProperty(
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_PUBLICATION_INTEGRALE_OU_EXTRAIT_LABEL_PROPERTY,
            publicationIntegraleOuExtrait
    ...
    @Override
    public String getDelaiPublicationLabel() {
        return PropertyUtil.getStringProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_DELAI_PUBLICATION_LABEL_PROPERTY
        );
    }

    @Override
    public void setDelaiPublicationLabel(String delaiPublication) {
        setProperty(
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_DELAI_PUBLICATION_LABEL_PROPERTY,
            delaiPublication
    ...
    @Override
    public TranspositionsContainer getApplicationLoi() {
        List<DossierTransposition> transpositions = new ArrayList<>(
            PropertyHelper.getListSerializableProperty(
                document,
                DossierSolonEpgConstants.DOSSIER_SCHEMA,
                DossierSolonEpgConstants.DOSSIER_APPLICATION_LOI_PROPERTY,
                DossierTranspositionImpl.class
            )
        );
        return new TranspositionsContainerImpl(transpositions);
    }

    @Override
    public void setApplicationLoi(TranspositionsContainer loisAppliquees) {
        // Dénormalisation des références des application lois
        setApplicationLoiRefs(
            ComplexTypeUtil.getListeComplexeTypeRef(new ArrayList<>(loisAppliquees.getTranspositions()))
        );
        ...
        PropertyHelper.setListSerializableProperty(
            ...
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_APPLICATION_LOI_PROPERTY,
            loisAppliquees.getTranspositions()
        );
    }

    @Override
    public TranspositionsContainer getTranspositionOrdonnance() {
        List<DossierTransposition> transpositions = new ArrayList<>(
            PropertyHelper.getListSerializableProperty(
                document,
                DossierSolonEpgConstants.DOSSIER_SCHEMA,
    ...
    @Override
    public void setTranspositionOrdonnance(TranspositionsContainer applicationOrdonnances) {
        // Dénormalisation des références des transpositions d'ordonnance
        setTranspositionOrdonnanceRefs(
            ComplexTypeUtil.getListeComplexeTypeRef(new ArrayList<>(applicationOrdonnances.getTranspositions()))
        );
        ...
        PropertyHelper.setListSerializableProperty(
            ...
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_TRANSPOSITION_ORDONNANCE_PROPERTY,
            applicationOrdonnances.getTranspositions()
        );
    }

    @Override
    public TranspositionsContainer getTranspositionDirective() {
        List<DossierTransposition> transpositions = new ArrayList<>(
            PropertyHelper.getListSerializableProperty(
                document,
                DossierSolonEpgConstants.DOSSIER_SCHEMA,
    ...
    @Override
    public void setTranspositionDirective(TranspositionsContainer directivesEuropeennes) {
        PropertyHelper.setListSerializableProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.DOSSIER_TRANSPOSITION_DIRECTIVE_PROPERTY,
            directivesEuropeennes.getTranspositions()
        );
    }
    ...
    public void setStatutArchivage(String statutArchivage) {
        // dénormalisation
        setArchive(
            VocabularyConstants.STATUT_ARCHIVAGE_DOSSIER_GENERE.equals(statutArchivage) ||
    ...
    public void setNorAttribue(Boolean norAttribue) {
        setProperty(
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
            DossierSolonEpgConstants.NOR_ATTRIBUE_DOSSIER_PROPERTY,
            norAttribue
        );
    }
    ...
    public List<Calendar> getDateEffet() {
        return PropertyHelper.getCalendarListProperty(
            document,
            DossierSolonEpgConstants.DOSSIER_SCHEMA,
