...
public class MesureApplicativeImpl extends TexteMaitreImpl implements MesureApplicative {
    ...
    public Calendar getDateObjectifPublication() {
        return getDateProperty(
            ...
            TexteMaitreConstants.DATE_OBJECTIF_PUBLICATION
        );
    }
    ...
    public void setDirectionResponsable(String directionResponsable) {
        setProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.DIRECTION_RESPONSABLE,
    ...
    public String getCalendrierConsultationsHCE() {
        return getStringProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.CALENDRIER_CONSULTATIONS_HCE
        );
    }
    ...
    public Calendar getDateDisponnibiliteAvantProjet() {
        return getDateProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.DATE_DISPONIBILITE_AVANT_PROJET
        );
    }
    ...
    public void setPoleChargeMission(String poleChargeMission) {
        setProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.POLE_CHARGE_MISSION,
            poleChargeMission
        );
    }
    ...
    public void setResponsableAmendement(String responsableAmendement) {
        setProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.RESPONSABLE_AMENDEMENT,
            responsableAmendement
        );
    }
    ...
    public String getResponsableAmendementLabel() {
        return SolonEpgServiceLocator
            .getSolonEpgVocabularyService()
            .getLabelFromId(
                VocabularyConstants.RESPONSABLE_AMENDEMENT_DIRECTORY,
                getResponsableAmendement(),
                STVocabularyConstants.COLUMN_LABEL
            );
    }
    ...
    public Boolean getMesureApplication() {
        return PropertyUtil.getBooleanProperty(
            document,
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.MESURE_APPLICATION
        );
    }
    ...
    public Calendar getDateMiseApplication() {
        return PropertyUtil.getCalendarProperty(
            document,
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.DATE_MISE_APPLICATION
        );
    }
