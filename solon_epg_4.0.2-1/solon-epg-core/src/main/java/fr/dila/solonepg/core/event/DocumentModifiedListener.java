...
public class DocumentModifiedListener extends AbstractFilterEventListener<DocumentEventContext> {
    ...
    public DocumentModifiedListener() {
        super(
            new String[] { DocumentEventTypes.DOCUMENT_UPDATED, DocumentEventTypes.DOCUMENT_CREATED },
            DocumentEventContext.class
        );
    }

    @Override
    protected void doHandleEvent(Event event, final DocumentEventContext ctx) {
