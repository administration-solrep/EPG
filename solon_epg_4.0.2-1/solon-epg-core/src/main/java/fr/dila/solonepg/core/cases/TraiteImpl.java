...
public class TraiteImpl extends TexteMaitreImpl implements Traite {
    ...
    public Boolean hasAutorisationRatification() {
        return getBooleanProperty(
            ...
            TexteMaitreConstants.AUTORISATION_RATIFICATION
        );
    }
    ...
    public void setDispoEtudeImpact(Boolean dispoEtudeImpact) {
        setProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.DISPO_ETUDE_IMPACT,
            dispoEtudeImpact
        );
    }
    ...
    public void setNorLoiRatification(String norLoiRatification) {
        setProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.NOR_LOI_RATIFICATION,
            norLoiRatification
        );
    }
    ...
    public void setDateDepotRatification(Calendar dateDepotRatification) {
        setProperty(
            TexteMaitreConstants.TEXTE_MAITRE_SCHEMA,
            TexteMaitreConstants.DATE_DEPOT_RATIFICATION,
            dateDepotRatification
        );
    }
}
