...
public class EpgDateHelper {
    ...
    public enum Operator {
        PLUS("label.operator.plus"),
        MINUS("label.operator.minus");
    ...
    public enum Period {
        DAY("label.period.day"),
        MONTH("label.period.month"),
        YEAR("label.period.year");
    ...
    public static List<String> getAllMonths() {
        ...
        List<String> results = (List<String>) CollectionUtils.selectRejected(
            months,
            PredicateUtils.identityPredicate(StringUtils.EMPTY)
        );
