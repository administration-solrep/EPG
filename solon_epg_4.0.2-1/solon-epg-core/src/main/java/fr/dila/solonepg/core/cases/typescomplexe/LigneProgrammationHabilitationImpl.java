...
public class LigneProgrammationHabilitationImpl extends ComplexeTypeImpl implements LigneProgrammationHabilitation {
    ...
    public LigneProgrammationHabilitationImpl(Map<String, Serializable> serializableMap) {
        if (serializableMap.get(LigneProgrammationHabilitationConstants.P_DATE_PREV_SAISINE_CE) instanceof Calendar) {
            this.datePrevisionnelleSaisineCE =
                (Calendar) serializableMap.get(LigneProgrammationHabilitationConstants.P_DATE_PREV_SAISINE_CE);
        }
        if (serializableMap.get(LigneProgrammationHabilitationConstants.P_MINISTERE_PILOTE) instanceof String) {
            this.ministerePilote =
                (String) serializableMap.get(LigneProgrammationHabilitationConstants.P_MINISTERE_PILOTE);
        }
        ...
        if (serializableMap.get(LigneProgrammationHabilitationConstants.P_TYPE_HABILITATION) instanceof String) {
            this.typeHabilitation =
                (String) serializableMap.get(LigneProgrammationHabilitationConstants.P_TYPE_HABILITATION);
        }
        ...
        if (serializableMap.get(LigneProgrammationHabilitationConstants.P_CONVENTION_DEPOT) instanceof String) {
            this.conventionDepot =
                (String) serializableMap.get(LigneProgrammationHabilitationConstants.P_CONVENTION_DEPOT);
        }
        if (serializableMap.get(LigneProgrammationHabilitationConstants.P_DATE_PREV_CM) instanceof Calendar) {
            this.datePrevisionnelleCM =
                (Calendar) serializableMap.get(LigneProgrammationHabilitationConstants.P_DATE_PREV_CM);
        }
    ...
    public void setSerializableMap(Map<String, Serializable> serializableMap) {
        ...
        Serializable typeHabilitation = serializableMap.get(
            LigneProgrammationHabilitationConstants.P_TYPE_HABILITATION
        );
        ...
        Serializable datePrevisionnelleSaisineCE = serializableMap.get(
            LigneProgrammationHabilitationConstants.P_DATE_PREV_SAISINE_CE
        );
