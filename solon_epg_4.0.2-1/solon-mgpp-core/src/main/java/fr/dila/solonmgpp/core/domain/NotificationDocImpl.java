...
public class NotificationDocImpl implements NotificationDoc, Serializable {
    ...
    public Calendar getDateArrive() {
        return PropertyUtil.getCalendarProperty(
            document,
            SolonMgppNotificationConstants.NOTIFICATION_SCHEMA,
            SolonMgppNotificationConstants.DATE_ARRIVE
        );
    }
    ...
    public String getEvenementId() {
        return PropertyUtil.getStringProperty(
            document,
            SolonMgppNotificationConstants.NOTIFICATION_SCHEMA,
            SolonMgppNotificationConstants.EVENEMENT_ID
        );
    }
    ...
    public List<String> getMessageCorbeilleList() {
        return PropertyUtil.getStringListProperty(
            document,
            SolonMgppNotificationConstants.NOTIFICATION_SCHEMA,
            SolonMgppNotificationConstants.MESSAGE_CORBEILLE_LIST
        );
    }
    ...
    public String getTypeNotification() {
        return PropertyUtil.getStringProperty(
            document,
            SolonMgppNotificationConstants.NOTIFICATION_SCHEMA,
            SolonMgppNotificationConstants.TYPE_NOTIFICATION
        );
    }
