...
public class QueryBuilder {
    ...
    private static final String IDENTIFIANTS_DOSSIERS_LEGISLATIFS_CONCERNES =
        "identifiants_dossiers_legislatifs_concernes";
    ...
    public RechercheDTO buildQueryAVI(CritereRechercheDTO critereRechercheDTO) {
        ...
        whereClause = StringUtils.removeEnd(whereClause, AND);
    ...
    private void buildIdDossierDecret(String nor, RechercheDTO rechercheDTO) {
        if (StringUtils.isNotBlank(nor)) {
            ...
            rechercheDTO.getWhereClause().append(" d.");
            rechercheDTO.getWhereClause().append(FichePresentationDecretImpl.PREFIX);
            rechercheDTO.getWhereClause().append(":");
            rechercheDTO.getWhereClause().append(FichePresentationDecretImpl.NOR);
            rechercheDTO.getWhereClause().append(" ILIKE ? ");
            rechercheDTO.getWhereClause().append(AND);
    ...
    public RechercheDTO buildQuery(CritereRechercheDTO critereRechercheDTO) {
        ...
        // Les deux clauses précédente doivent être une seule condition OR
        // (car on cherche la même valeure dans deux champs uniques différent).
        String newConditions = rechercheDTO.getWhereClause().toString();
        if (StringUtils.isNotBlank(newConditions)) {
            rechercheDTO.setWhereClause(new StringBuilder());
            newConditions = StringUtils.removeEnd(newConditions, AND);
            rechercheDTO
                .getWhereClause()
                .append("(")
                .append(newConditions.replaceAll(AND, OR))
                .append(") ")
                .append(AND);
        }
        ...
        buildElement(
            MSG_PREFIX,
            MSG_DATE_EVENEMENT,
            critereRechercheDTO.getDateEvenementMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(EVT_PREFIX, COMMENTAIRE, critereRechercheDTO.getDescription(), rechercheDTO);
        ...
        buildElement(EVT_PREFIX, CO_SIGNATAIRE_COLLECTIF, critereRechercheDTO.getCosignataire(), rechercheDTO);
        ...
        buildElement(
            EVT_PREFIX,
            COMMISSION_SAISIE_AU_FOND_NOM,
            critereRechercheDTO.getCommissionSaisieAuFond(),
            rechercheDTO,
            Boolean.TRUE
        );
        buildElement(
            EVT_PREFIX,
            COMMISSION_SAISIE_POUR_AVIS_NOM,
            critereRechercheDTO.getCommissionSaisiePourAvis(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_DISTRIBUTION,
            critereRechercheDTO.getDateDistributionElectronique(),
            rechercheDTO
        );
        buildElement(
            EVT_PREFIX,
            DATE_DISTRIBUTION,
            critereRechercheDTO.getDateDistributionElectroniqueMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DEPOT_RAPPORT_DATE,
            critereRechercheDTO.getDateDepotRapport(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            ...
            critereRechercheDTO.getDateEngagementProcedure(),
            rechercheDTO
        );
        buildElement(
            EVT_PREFIX,
            DATE_ENGAGEMENT_PROCEDURE,
            critereRechercheDTO.getDateEngagementProcedureMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_REFUS_PROC_ACC,
            critereRechercheDTO.getDateRefusEngagementProcAcc(),
            rechercheDTO
        );
        buildElement(
            EVT_PREFIX,
            DATE_REFUS_PROC_ACC,
            critereRechercheDTO.getDateRefusEngagementProcAccAssMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_PROMULGATION,
            critereRechercheDTO.getDatePromulgationMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_PUBLICATION,
            critereRechercheDTO.getDatePublicationMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_CONVOCATION,
            critereRechercheDTO.getDateConvocationMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_DESIGNATION,
            critereRechercheDTO.getDateDesignationMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            IDENTIFIANTS_DOSSIERS_LEGISLATIFS_CONCERNES,
            critereRechercheDTO.getDossierLegislatif(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_PRESENTATION,
            critereRechercheDTO.getDatePresentationMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_DECLARATION,
            critereRechercheDTO.getDateDeclarationMax(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            ...
            critereRechercheDTO.getGroupeParlementaire(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_REFUS_PROC_ACC_ASS1,
            critereRechercheDTO.getDateRefusEngagementProcAccAss1(),
            rechercheDTO
        );
        buildElement(
            EVT_PREFIX,
            DATE_REFUS_PROC_ACC_ASS1,
            critereRechercheDTO.getDateRefusEngagementProcAccAss1Max(),
            rechercheDTO,
            Boolean.TRUE
        );
        ...
        buildElement(
            EVT_PREFIX,
            DATE_CONFERENCE_PRES_ASS2,
            critereRechercheDTO.getDateConfPresidentsAss2(),
            rechercheDTO
        );
        buildElement(
            EVT_PREFIX,
            DATE_CONFERENCE_PRES_ASS2,
            critereRechercheDTO.getDateConfPresidentsAss2Max(),
            rechercheDTO,
            Boolean.TRUE
        );
    ...
    private void buildElement(
        ...
        if (value != null) {
            if (String.class.isAssignableFrom(value.getClass()) && StringUtils.isNotBlank((String) value)) {
                ...
                Integer.class.isAssignableFrom(value.getClass()) || Long.class.isAssignableFrom(value.getClass())
            ) {
    ...
    private void buildListElement(
        ...
        if (isSpecial != null && isSpecial) {
            ...
            if (list.size() == 1) {
                ...
                rechercheDTO.getWhereClause().append(StringHelper.getQuestionMark(list.size()));
                rechercheDTO.getWhereClause().append(") ");
            }
    ...
    private void addOrderByClause(RechercheDTO rechercheDTO, List<SortInfo> sortInfos) {
        ...
        whereClause = StringUtils.removeEnd(whereClause, VIRGULE);
    ...
    private void buildIdDossierDR(String nor, RechercheDTO rechercheDTO) {
        if (StringUtils.isNotBlank(nor)) {
            ...
            rechercheDTO.getWhereClause().append(" d.");
            rechercheDTO.getWhereClause().append(FichePresentationDRImpl.PREFIX);
            rechercheDTO.getWhereClause().append(":");
            rechercheDTO.getWhereClause().append(FichePresentationDRImpl.ID_DOSSIER);
            rechercheDTO.getWhereClause().append(" ILIKE ? ");
            rechercheDTO.getWhereClause().append(AND);
    ...
    private void buildIdDossierOep(String nor, RechercheDTO rechercheDTO) {
        if (StringUtils.isNotBlank(nor)) {
            ...
            rechercheDTO.getWhereClause().append(" d.");
            rechercheDTO.getWhereClause().append(FichePresentationOEPImpl.PREFIX);
            rechercheDTO.getWhereClause().append(":");
            rechercheDTO.getWhereClause().append(FichePresentationOEPImpl.ID_DOSSIER);
            rechercheDTO.getWhereClause().append(" ILIKE ? ");
            rechercheDTO.getWhereClause().append(AND);
    ...
    private void buildNomOEP(String nomOep, RechercheDTO rechercheDTO) {
        if (StringUtils.isNotBlank(nomOep)) {
            ...
            rechercheDTO.getWhereClause().append(FichePresentationOEPImpl.PREFIX);
            rechercheDTO.getWhereClause().append(":");
            rechercheDTO.getWhereClause().append(FichePresentationOEPImpl.NOM_ORGANISME);
            rechercheDTO.getWhereClause().append(" ILIKE ? ");
            rechercheDTO.getWhereClause().append(AND);
    ...
    private void buildTypeActeDossier(CritereRechercheDTO critereRechercheDTO, RechercheDTO rechercheDTO) {
        ...
        rechercheDTO.getWhereClause().append(" IN (");
        rechercheDTO.getWhereClause().append(StringHelper.getQuestionMark(critereRechercheDTO.getTypeActes().size()));
        rechercheDTO.getWhereClause().append(") ");
        rechercheDTO.getWhereClause().append(AND);
