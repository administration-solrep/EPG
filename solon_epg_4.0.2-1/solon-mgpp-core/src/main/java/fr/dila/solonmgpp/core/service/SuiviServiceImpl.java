...
public class SuiviServiceImpl implements SuiviService {
    ...
    @Override
    public List<DocumentModel> getTexteLoiEnCoursDiscussionNonAdoptee(final CoreSession session) {
    ...
    @Override
    public List<DocumentModel> getAllEcheancierPromulgation(final CoreSession session) {
        final String query =
            "SELECT fl.ecm:uuid as id  FROM " +
            FicheLoi.DOC_TYPE +
            " as fl WHERE fl." +
            FicheLoi.PREFIX +
            ":" +
            FicheLoi.ECHEANCIER_PROMULGATION +
            " = 1";
        return QueryUtils.doUFNXQLQueryAndFetchForDocuments(session, FicheLoi.DOC_TYPE, query, new Object[] {});
    }

    @Override
    public Long getEcheancierPromulgationCount(final CoreSession session) {
        final String query =
            "SELECT fl.ecm:uuid as id  FROM " +
            FicheLoi.DOC_TYPE +
            " as fl WHERE fl." +
    ...
    @Override
    public List<DocumentModel> getEcheancierPromulgationPage(
    ...
    public EcheancierPromulgation creerEcheancierPromulgation(final CoreSession session, final String idDossier) {
        final DocumentModel echeancierPromulgationModel = session.createDocumentModel(
            "/case-management/echeancier-promulgation",
            idDossier + "_AP",
            EcheancierPromulgation.ECHANCIER_PROMULGATION_DOC_TYPE
        );
        final EcheancierPromulgation echeancierPromulgation = echeancierPromulgationModel.getAdapter(
            EcheancierPromulgation.class
        );
    ...
    @Override
    public EcheancierPromulgation findOrCreateEcheancierPromulgation(
        final CoreSession session,
        final String idDossier
    ) {
        synchronized (this) {
            final StringBuilder queryBuilder = new StringBuilder(
                "SELECT d.ecm:uuid as id  FROM " + EcheancierPromulgation.ECHANCIER_PROMULGATION_DOC_TYPE + " as d"
            );
            ...
            if (docs == null || docs.isEmpty()) {
                ...
                throw new NuxeoException(
                    "Plusieurs Echeancier de Promulgation trouvées pour le meme dossier " + idDossier + "."
                );
            } else {
    ...
    @Override
    public void creerActiviteParlementaire(
        final CoreSession session,
        final String idDossier,
        final String activite,
        final String assemblee,
        final Date date
    ) {
        final String dateStr = SolonDateConverter.DATE_NOSEP.format(date);
        final Calendar cal = DateUtil.toCalendarFromNotNullDate(date);
        DocumentModel activiteParlementaireModel = getActiviteParlementaireByDossierIdDateAct(
            session,
            idDossier,
            cal,
            activite,
        ...
        if (activiteParlementaireModel == null) {
            activiteParlementaireModel =
                session.createDocumentModel(
                    "/case-management/activite-parlementaire",
        ...
        final ActiviteParlementaire activiteParlementaire = activiteParlementaireModel.getAdapter(
            ActiviteParlementaire.class
        );
    ...
    @Override
    public void removeActiviteParlementaire(final CoreSession session, final String activiteId) {
        synchronized (this) {
    ...
    @Override
    public void removeSemaineParlementaire(final CoreSession session, final String activiteId) {
        synchronized (this) {
            final DocumentModel doc = session.getDocument(new IdRef(activiteId));
            if (doc != null) {
    ...
    @Override
    public List<DocumentModel> getAllTexteLoiPourCalendrierParlementaire(
        final CoreSession session,
        final Date dateDeDebutFiltre,
        final Date dateDeFinFiltre
    ) {
        List<DocumentModel> list = new ArrayList<DocumentModel>();

        List<String> listeDossierId = getAllDossierIdsForActiviteParlementaire(
            session,
            dateDeDebutFiltre,
            dateDeFinFiltre
        );
    ...
    @Override
    public List<Calendar> getAllDateActiviteParlementaire(final CoreSession session) {
        final String today = DateLiteral.dateFormatter.print(new Date().getTime());
        final String query =
            "SELECT Distinct a." +
            ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_PREFIX +
            ":" +
    ...
    @Override
    public List<Calendar> getAllDateActiviteParlementaire(
        final CoreSession session,
        ...
        final StringBuilder query = new StringBuilder("SELECT Distinct a.")
            .append(ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_PREFIX)
            .append(":")
            .append(ActiviteParlementaire.DATE)
            .append(" as dateActivite")
            .append(" FROM ")
            .append(ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_DOC_TYPE)
            .append(" as a");
    ...
    @Override
    public List<DocumentModel> getAllActiviteParlementaireByDossierId(
        final CoreSession session,
        ...
        queryBuilder.append(
            " = '" + DossierId + "' ORDER BY d." + ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_PREFIX + ":date"
        );
        return QueryUtils.doUFNXQLQueryAndFetchForDocuments(
            session,
            ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_DOC_TYPE,
    ...
    public List<DocumentModel> getAllSemaineParlementaire(final CoreSession session, final String assemble) {
        ...
        queryBuilder.append(
            " = '" + assemble + "' ORDER BY d." + SemaineParlementaire.SEMAINE_PARLEMENTAIRE_PREFIX + ":dateDebut"
        );
        return QueryUtils.doUFNXQLQueryAndFetchForDocuments(
            session,
    ...
    @Override
    public void creerSemaineParlementaire(
        final CoreSession session,
        ...
        final String dateDebutStr = SolonDateConverter.DATE_NOSEP.format(dateDebut);
        final String dateFinStr = SolonDateConverter.DATE_NOSEP.format(dateFin);
        ...
        if (doc != null) {
            ...
            if (doc != null) {
                ...
                if (doc != null) {
                    ...
                    creerNouvelleSemaineParlementaire(
                        session,
                        orientation,
                        assemblee,
                        calendarB,
                    ...
                    final List<DocumentModel> documentModelList = getAllSemaineParlemetaireIncluDansLaPeriode(
                        session,
                        assemblee,
                        dateDebut,
                        dateFin
    ...
    private List<DocumentModel> getAllSemaineParlemetaireIncluDansLaPeriode(
        final CoreSession session,
        final String assemblee,
        final Calendar dateDebut,
        final Calendar dateFin
    ...
    private DocumentModel getAllSemainesAvantDateDebutEtAvantDateFin(
        final CoreSession session,
        final String assemblee,
        final Calendar dateDebut,
        final Calendar dateFin
    ...
    private DocumentModel getAllSemainesAvantDateDebutEtApresDateFin(
        final CoreSession session,
        final String assemblee,
        final Calendar dateDebut,
        final Calendar dateFin
    ...
    private DocumentModel getAllSemainesApresDateDebutEtApresDateFin(
        final CoreSession session,
        final String assemblee,
        final Calendar dateDebut,
        final Calendar dateFin
    ...
    private DocumentModel getActiviteParlementaireByDossierIdDateAct(
        final CoreSession session,
        final String idDossier,
        final Calendar date,
        final String activite,
    ...
    @Override
    public List<String> getListIdsDossierPublie(final CoreSession session) {
        if (session == null) {
            return null;
        }
        ...
        final String query =
            "SELECT d." +
            FichePresentationDRImpl.PREFIX +
            ":" +
            FichePresentationDRImpl.ID_DOSSIER +
            " as idDossier from " +
            FichePresentationDRImpl.DOC_TYPE +
            " as d";
        final List<String> idDossierList = QueryUtils.doUFNXQLQueryAndMapping(
            session,
            query,
            null,
    ...
    private List<String> getAllDossierIdsForActiviteParlementaire(
        final CoreSession session,
        final Date dateDeDebutFiltre,
        final Date dateDeFinFiltre
    ) {
        ...
        final StringBuilder query = new StringBuilder("SELECT Distinct a.")
            .append(ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_PREFIX)
            .append(":")
            .append(ActiviteParlementaire.ID_DOSSIER)
            .append(" as idDossier")
            .append(" FROM ")
            .append(ActiviteParlementaire.ACTIVITE_PARLEMENTAIRE_DOC_TYPE)
            .append(" as a")
    ...
    public StringBuffer getEcheancePrHtml(final List<String[]> listEcheancier, final String[] entetesDesColonnes) {
        ...
        script.append("<style>");
        script.append(
            "th {background: none repeat scroll 0 0 #F3EFDD;border-bottom: 1px solid #C7C7C7; border-top: 2px solid #B5B1A6; color: #000000; padding: 5px 3px;text-align: left; white-space: nowrap;}"
        );
    ...
    @Override
    public void diffuserCalendrierParlementaire(
        final Map<String, List<Map<String, String>>> listedeSemainesParTypes,
        final List<Date> listeDeToutesLesDatesDesActivites,
        ...
        final StringBuffer html = getHtml(
            listedeSemainesParTypes,
            listeDeToutesLesDatesDesActivites,
            listeDeToutLesLois,
    ...
    private StringBuffer getJavaScript(
        ...
        for (final Map.Entry<String, List<Map<String, String>>> assemblee : listedeSemainesParTypes.entrySet()) {
            script.append(
                "setSameHeightToTheseRows(\"fixedTable_Upper_Header_" +
                assemblee.getKey() +
                "\", \"scrollableTable_Upper_Header_" +
                assemblee.getKey() +
                "\");"
            );
        }
    ...
    private StringBuffer getBody(
        ...
        if (listeDeToutLesLois.size() > 0) {
            ...
            script.append(
                ...
                (widthOfFirstColumn + widthOfSecondColumn) +
                "px;; padding: 0px; border: 0px;\">"
            );
            script.append(
                "<div id=\"fixedDiv\" class=\"fixedDiv\" style=\"width: " +
                (widthOfFirstColumn + widthOfSecondColumn) +
                "px; margin-bottom: 2000px;\">"
            );
            ...
            script.append(
                "<div id=\"scrollableDiv\" style=\"overflow: auto; width: " +
                (widthOfMainTable - widthOfFirstColumn - widthOfSecondColumn) +
                "px; margin-bottom: 2000px;\">"
            );
            script.append(
                "<table id=\"scrollableTable\" class=\"scrollableTable\" class=\"dataOutput\" style=\"width: " +
                listeDeToutesLesDatesDesActivites.size() *
                150 +
                "px; margin-bottom: 10px ! important;\">"
            );
            script.append("<thead>");
            ...
            for (final Map.Entry<String, List<Map<String, String>>> assemblee : listedeSemainesParTypes.entrySet()) {
                ...
                for (final Map<String, String> semaineParAssemblee : assemblee.getValue()) {
                    if (semaineParAssemblee == null) {
                        ...
                        script.append(
                            "<td colspan=\"" +
                            semaineParAssemblee.get("colspan") +
            ...
            for (final Date dateDuneActivite : listeDeToutesLesDatesDesActivites) {
                script.append("<th>");
                script.append(SolonDateConverter.DATE_SLASH.format(dateDuneActivite));
                script.append("</th>");
            }
            script.append("</tr>");
            script.append("</thead>");
            ...
            for (int ficheLoiIndex = 0; ficheLoiIndex < listeDeToutLesLois.size(); ficheLoiIndex++) {
                ...
                final Collection<List<ActiviteParlementaire>> toutesLesActivitesParlementaireDeCeLoi = mapDeToutesLesActivitesParlementaireDeCeLoi.get(
                    ficheLoi.getIdDossier()
                );
    ...
    private void creerNouvelleSemaineParlementaire(
        final CoreSession session,
        final String orientation,
        final String assemblee,
        final Calendar dateDebut,
        ...
        final DocumentModel semaineParlementaireModel = session.createDocumentModel(
            "/case-management/semaine-parlementaire",
            assemblee + "_SP_" + dateDebutStr + "_" + dateFinStr,
            SemaineParlementaire.SEMAINE_PARLEMENTAIRE_DOC_TYPE
        );
        final SemaineParlementaire semaineParlementaireNew = semaineParlementaireModel.getAdapter(
            SemaineParlementaire.class
        );
