...
public class SolonMgppServiceLocator {
    ...
    public static ModeleCourrierService getModeleCourrierService() {
        return getRequiredService(ModeleCourrierService.class);
    }

    public static CourrierProcessorService getCourrierProcessorService() {
        return getRequiredService(CourrierProcessorService.class);
    }

    public static CommunicationCourrierService getCommunicationCourrierService() {
        return getRequiredService(CommunicationCourrierService.class);
    }
