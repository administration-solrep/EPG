...
public class FicheLoiImpl implements FicheLoi, Serializable {
    ...
    public String getNomCompletChargeMission() {
        return PropertyUtil
            .getStringListProperty(document, SCHEMA, NOM_COMPLET_CHARGE_MISSION)
            .stream()
            .findFirst()
            .orElse(null);
    }
    ...
    public void setNatureLoi(NatureLoi natureLoi) {
        PropertyUtil.setProperty(document, SCHEMA, NATURE_LOI, natureLoi != null ? natureLoi.toString() : null);
    }
