...
public class NavetteServiceImpl implements NavetteService {
    ...
    @Override
    public Boolean hasNavette(final CoreSession session, final String idFicheLoi) {
    ...
    @Override
    public List<DocumentModel> fetchNavette(final CoreSession session, final String idFicheLoi) {
        final StringBuilder query = new StringBuilder(" SELECT n.ecm:uuid as id FROM ");
        query.append(Navette.DOC_TYPE);
        query.append(" as n WHERE n.");
        query.append(Navette.PREFIX);
    ...
    @Override
    public void addNavetteToFicheLoi(
        final CoreSession session,
        final String idEvenement,
        final EvenementType typeEvenement
    ) {
        ...
        if (chercherEvenementResponse == null) {
            ...
            final NuxeoException clientExc = new NuxeoException(
                "Erreur de communication avec SOLON EPP, la récupération de la communication a échoué." +
    ...
    public void addNavetteToFicheLoi(final CoreSession session, final EppEvtContainer eppEvtContainer) {
        ...
        if (EvenementType.EVT_01.equals(typeEvenement)) {
            ...
            if (eppEvt12 != null) {
                final NavetteFicheLoi navetteFicheLoi = new NavetteFicheLoi(
                    eppEvt12.getIdDossier(),
                    eppEvt12.getNiveauLecture()
                );
                navetteFicheLoi.sortAdoption =
                    eppEvt12.getSortAdoption() == null ? null : eppEvt12.getSortAdoption().value();
                ...
                if (Institution.ASSEMBLEE_NATIONALE.equals(eppEvt12.getEmetteur())) {
                    navetteFicheLoi.dateAdoptionAN =
                        DateUtil.xmlGregorianCalendarToCalendar(eppEvt12.getDateAdoption());
                    navetteFicheLoi.sortAdoptionAN =
                        eppEvt12.getSortAdoption() == null ? null : eppEvt12.getSortAdoption().value();
                } else if (Institution.SENAT.equals(eppEvt12.getEmetteur())) {
                    navetteFicheLoi.dateAdoptionSE =
                        DateUtil.xmlGregorianCalendarToCalendar(eppEvt12.getDateAdoption());
                    navetteFicheLoi.sortAdoptionSE =
                        eppEvt12.getSortAdoption() == null ? null : eppEvt12.getSortAdoption().value();
                }

                Navette navette = updateNavette(session, navetteFicheLoi);
                if (
                    eppEvt12.getVersionCourante() != null &&
                    eppEvt12.getVersionCourante().getMajeur() == 1 &&
            ...
            if (eppEvt24 != null) {
                ...
                navetteFicheLoi.sortAdoption =
                    eppEvt24.getSortAdoption() == null ? null : eppEvt24.getSortAdoption().value();
                ...
                if (Institution.ASSEMBLEE_NATIONALE.equals(eppEvt24.getEmetteur())) {
                    navetteFicheLoi.dateAdoptionAN =
                        DateUtil.xmlGregorianCalendarToCalendar(eppEvt24.getDateAdoption());
                    navetteFicheLoi.sortAdoptionAN =
                        eppEvt24.getSortAdoption() == null ? null : eppEvt24.getSortAdoption().value();
            ...
            if (eppEvt13 != null) {
                Navette navette = createNavette(
                    session,
                    new NavetteFicheLoi(eppEvt13.getIdDossier(), eppEvt13.getNiveauLecture())
                );
                if (
                    eppEvt13.getVersionCourante() != null &&
                    eppEvt13.getVersionCourante().getMajeur() == 1 &&
            ...
            if (eppEvt14 != null) {
                final NavetteFicheLoi navetteFicheLoi = new NavetteFicheLoi(
                    eppEvt14.getIdDossier(),
                    eppEvt14.getNiveauLecture()
                );

                navetteFicheLoi.sortAdoption =
                    eppEvt14.getSortAdoption() == null ? null : eppEvt14.getSortAdoption().value();
                ...
                if (Institution.ASSEMBLEE_NATIONALE.equals(eppEvt14.getEmetteur())) {
                    navetteFicheLoi.dateAdoptionAN =
                        DateUtil.xmlGregorianCalendarToCalendar(eppEvt14.getDateAdoption());
                    navetteFicheLoi.sortAdoptionAN =
                        eppEvt14.getSortAdoption() == null ? null : eppEvt14.getSortAdoption().value();
                ...
                Navette navette = updateNavette(session, navetteFicheLoi);
                if (
                    eppEvt14.getVersionCourante() != null &&
                    eppEvt14.getVersionCourante().getMajeur() == 1 &&
    ...
    private Navette updateNavette(final CoreSession session, final NavetteFicheLoi navetteFicheLoi) {
        final FicheLoi ficheLoi = SolonMgppServiceLocator
            .getDossierService()
            .findOrCreateFicheLoi(session, navetteFicheLoi.idDossier);

        Navette navette = findNavette(session, navetteFicheLoi.niveauLecture, ficheLoi);

        if (navette == null) {
            navette = createNavette(session, ficheLoi);
        ...
        if (StringUtils.isBlank(navette.getDocument().getId())) {
            LOGGER.info(
                session,
                MgppLogEnumImpl.UPDATE_NAVETTE_TEC,
    ...
    private Navette createNavette(final CoreSession session, final FicheLoi ficheLoi) {
        final DocumentModel modelDesired = session.createDocumentModel(
            ficheLoi.getDocument().getPathAsString(),
