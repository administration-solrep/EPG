...
public class RunExtractionOperation {
    ...
    public void run() {
        ...
        eventProducer.fireEvent(inlineEventContext.newEvent(SolonEpgEventConstant.BATCH_EVENT_RETOUR_VITAM));
    }
}
