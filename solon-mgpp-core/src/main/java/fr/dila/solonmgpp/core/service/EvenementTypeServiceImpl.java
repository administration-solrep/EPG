...
public class EvenementTypeServiceImpl extends DefaultComponent implements EvenementTypeService {
    ...
    static {
        ...
        mapConversionMenu.put(
            SolonMgppActionConstant.DECRET,
            "ORGANISATION_SESSION_EXTRAORDINAIRE,CONVOCATION_CONGRES"
        );
        mapConversionMenu.put(
            SolonMgppActionConstant.INTERVENTION_EXTERIEURE,
        ...
        mapConversionMenu.put(
            SolonMgppActionConstant.DECLARATION_DE_POLITIQUE_GENERALE,
            "DECLARATION_DE_POLITIQUE_GENERALE"
        );
        mapConversionMenu.put(
            SolonMgppActionConstant.DECLARATION_SUR_UN_SUJET_DETERMINE,
        ...
        mapConversionMenu.put(
            SolonMgppActionConstant.AUTRES_DOCUMENTS_TRANSMIS_AUX_ASSEMBLEES,
    ...
    @Override
    public EvenementTypeDescriptor getEvenementType(String evenementType) {
    ...
    @Override
    public boolean isTypeCreateur(String evenementType) {
        return getEvenementType(evenementType).isCreateur();
    }

    @Override
    public boolean isTypeSuccessif(String evenementType) {
        return getEvenementType(evenementType).isSuccessif();
    }

    @Override
    public boolean isDemandeAr(String evenementType) {
        return getEvenementType(evenementType).isDemandeAr();
    }

    @Override
    public boolean isEmetteurAutorise(String evenementType, String emetteur) {
    ...
    @Override
    public boolean isDestinataireAutorise(String evenementType, String destinataire) {
        DistributionDescriptor distribution = getEvenementType(evenementType).getDistribution();
        if (distribution == null) {
            throw new NuxeoException(
                "La distribution n'est pas renseigné pour le type de communication : " + evenementType
    ...
    @Override
    public boolean isDestinataireCopieAutorise(String evenementType, String destinataireCopie) {
        DistributionDescriptor distribution = getEvenementType(evenementType).getDistribution();
        if (distribution == null) {
            throw new NuxeoException(
                "La distribution n'est pas renseigné pour le type de communication : " + evenementType
    ...
    @Override
    public boolean isDestinataireCopieObligatoire(String evenementType) {
        DistributionDescriptor distribution = getEvenementType(evenementType).getDistribution();
        if (distribution == null) {
            throw new NuxeoException(
                "La distribution n'est pas renseigné pour le type de communication : " + evenementType
    ...
    @Override
    public boolean isPieceJointeObligatoire(String evenementType, String pieceJointeType) {
    ...
    @Override
    public boolean isCreerBrouillon(String evenementType) {
        return getEvenementType(evenementType).isCreerBrouillon();
    }

    @Override
    public boolean isCompleter(String evenementType) {
        return getEvenementType(evenementType).isCompleter();
    }

    @Override
    public boolean isRectifier(String evenementType) {
        return getEvenementType(evenementType).isRectifier();
    }

    @Override
    public boolean isAnnuler(String evenementType) {
    ...
    public List<EvenementTypeDescriptor> findEvenementTypeCreateur(String currentMenu) {
        ...
        for (EvenementTypeDescriptor evenementTypeDescriptor : evenementTypeMap.values()) {
            ...
            if (
                evenementTypeDescriptor.isCreateur() &&
                ...
                (
                    "DIVERS".equals(evenementTypeDescriptor.getProcedure()) ||
                    mapConversionMenu.get(currentMenu) != null &&
            ...
            if (
                ...
                (
                    currentEvtTypeDescriptor
                        .getProcedure()
                        .equals(VocabularyConstants.CATEGORIE_EVENEMENT_DIVERS_VALUE) ||
                    (
    ...
    public List<EvenementTypeDescriptor> findEvenementType() {
        return new ArrayList<>(evenementTypeMap.values());
    }

    @Override
    public EvenementTypeDescriptor findEvenementTypeById(String evtId) {
        return evenementTypeMap.get(evtId);
    }
    ...
    public List<EvenementTypeDescriptor> findEvenementTypeByProcedure(String menu) {
        ...
        for (EvenementTypeDescriptor evenementTypeDescriptor : evenementTypeMap.values()) {
            if (
                "DIVERS".equals(evenementTypeDescriptor.getProcedure()) ||
                mapConversionMenu.get(menu) != null &&
    ...
    @Override
    public List<FichePresentationOEP> getAllFichesPresentationOEP(CoreSession session) {
        ...
        queryBuilder.append(FichePresentationOEPImpl.DOC_TYPE).append(" as d");
    ...
    @Override
    public List<String> findEvenementTypeNameByProcedure(String menu) {
        return findEvenementTypeByProcedure(menu)
            .stream()
