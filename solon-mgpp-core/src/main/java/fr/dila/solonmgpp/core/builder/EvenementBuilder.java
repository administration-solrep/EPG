...
public class EvenementBuilder {
     ...
     */
    public void buildEvenementDTOFromContainer(
        ...
        EvenementTypeDescriptor evenementTypeDescriptor = SolonMgppServiceLocator
            ...
            .getEvenementType(eppEvtContainer.getType().value());
        if (evenementTypeDescriptor != null) {
            Map<String, Serializable> map = new HashMap<>();
            map.put(EvenementDTOImpl.LABEL, evenementTypeDescriptor.getLabel());
            map.put(EvenementDTOImpl.NAME, evenementTypeDescriptor.getName());
        ...
        if (eppBaseEvenement == null) {
            throw new NuxeoException("Les données récupérées de SOLON EPP sont incohérentes");
        }
    ...
    public void initEvenementDTOWithEppEvt(
        EvenementDTO evenementDTO,
        ...
        if (list == null) {
            if (byte[].class.isAssignableFrom(fieldClass)) {
                ...
                if (Mandat.class.isAssignableFrom(fieldClass)) {
                    ...
                    Map<String, Serializable> mapResult = buildNewSerializableField(
                        dto,
                        dtoFieldName,
                        fieldClass,
                        session
    ...
    @SuppressWarnings("unchecked")
    private Map<String, Serializable> buildNewSerializableField(
        Map<String, Serializable> dto,
        String dtoFieldName,
        Class<?> fieldClass,
        CoreSession session
     ...
     * @param dtoFieldName
     */
    private void setDateObject(
        Map<String, Serializable> evenementDTO,
