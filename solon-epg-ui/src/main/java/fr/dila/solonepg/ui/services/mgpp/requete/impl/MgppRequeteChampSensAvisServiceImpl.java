...
public class MgppRequeteChampSensAvisServiceImpl implements ChampParameter {

    @Override
    public Map<String, Serializable> getAdditionalParameters() {
        return ImmutableMap.of(
            SSRechercheChampConstants.OPTIONS_PARAMETER_NAME,
            new ArrayList<>(MgppUIServiceLocator.getMgppSelectValueUIService().getAllSensAvis())
        );
    }
}
