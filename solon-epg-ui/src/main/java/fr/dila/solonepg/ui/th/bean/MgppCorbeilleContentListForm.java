...
public class MgppCorbeilleContentListForm extends PaginationForm {
    private static final String NOR_TRI = "norTri";
    private static final String ID_TRI = "idTri";
    private static final String ID_DOSSIER_TRI = "idDossierTri";
    private static final String INTITULE_TRI = "intituleTri";
    private static final String EMETTEUR_TRI = "emetteurTri";
    private static final String OBJET_TRI = "objetTri";
    private static final String ORG_NOM_TRI = "nomOrgTri";
    private static final String OEP_NOM_TRI = "nomOepTri";
    private static final String DATE_CREATION_TRI = "dateCreationTri";
    private static final String TITRE_ACTE_TRI = "titreTri";
    private static final String DATE_ARRIVEE_TRI = "dateArriveeTri";
    private static final String DATE_DEPOT_TRI = "dateDepotTri";
    private static final String DATE_DEBUT_TRI = "dateDebutTri";
    private static final String DATE_FIN_TRI = "dateFinTri";
    private static final String DATE_PUB_TRI = "datePubTri";
    private static final String DATE_TRANS_TRI = "dateTransTri";
    private static final String STATUT_TRI = "statutTri";
    private static final String TYPE_ACTE_TRI = "typeActeTri";
    private static final String TYPE_RAPPORT_TRI = "typeRapportTri";
    private static final String BASE_LEGALE_TRI = "baseLegaleTri";
    private static final String MIN_RATTACH_TRI = "minRattachTri";
    private static final String TEXTE_REF_TRI = "texteRefTri";

    private Map<String, Object> formData;

    @SuppressWarnings("unchecked")
    public MgppCorbeilleContentListForm(String json) {
        super();
        Gson gson = new Gson();
        formData = gson.fromJson(json, Map.class);

        if (formData != null) {
            if (StringUtils.isNotEmpty((String) formData.get(PAGE_PARAM_NAME))) {
                setPage((String) formData.get(PAGE_PARAM_NAME));
            }
            if (StringUtils.isNotEmpty((String) formData.get(SIZE_PARAM_NAME))) {
    ...
    public MgppCorbeilleContentListForm() {
