...
@Operation(id = DeleteDossier.ID, category = Constants.CAT_DOCUMENT, label = "Delete Dossier", description = "Delete Dossier .")
                ...
                new UnrestrictedSessionRunner(session) {
                    ...
                    public void run() throws ClientException {
                        try {
                           ...
                           throw new ClientException("erreur lors de la suppression du dossier " + dossierDoc.getTitle(),e);
                        }
                    }
                }.runUnrestricted();
