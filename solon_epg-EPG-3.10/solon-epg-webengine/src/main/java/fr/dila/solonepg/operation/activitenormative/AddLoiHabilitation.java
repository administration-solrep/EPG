...
@Operation(id = AddLoiHabilitation.ID, category = Constants.CAT_DOCUMENT, label = "Add Loi Habilitation", description = "Add Loi Habilitation")
public class AddLoiHabilitation  {
    ...
    public DocumentModel run() throws Exception {
        ...
        try {
            ...
            ActiviteNormative activiteNormative = SolonEpgServiceLocator.getActiviteNormativeService().findOrCreateActiviteNormativeByNor(session, numeroNor);
