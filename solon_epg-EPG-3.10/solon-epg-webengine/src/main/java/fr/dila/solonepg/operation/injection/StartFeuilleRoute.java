...
@Operation(id = StartFeuilleRoute.ID, category = Constants.CAT_DOCUMENT, label = "Start Feuille Route", description = "Start Feuille Route")
public class StartFeuilleRoute {
    ...
    public DocumentModel run() throws Exception {
        ...
        try {
            ...
            STFeuilleRoute stRouteInstance = routeInstanceDoc.getAdapter(STFeuilleRoute.class);
