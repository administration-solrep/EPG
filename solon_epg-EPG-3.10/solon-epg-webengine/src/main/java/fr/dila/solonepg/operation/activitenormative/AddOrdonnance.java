...
@Operation(id = AddOrdonnance.ID, category = Constants.CAT_DOCUMENT, label = "Add Ordonnance", description = "Add Ordonnance")
public class AddOrdonnance {
	...
	public DocumentModel run() throws Exception {
		...
		try {
			...
			Ordonnance ordonnance = SolonEpgServiceLocator.getActiviteNormativeService().createOrdonnanceReprise(
					ordonnanceDTO, session);
