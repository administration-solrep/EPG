...
public interface BordereauService {
	 ...
	 * @param sipFile
	 */
	void completeBordereau(DossierExtractionBordereau bordereau, File sipFile) throws IOException;
	 ...
	 * @param bordereau
	 */
	void saveBordereau(DossierExtractionBordereau bordereau) throws ClientException;
	 ...
	 */
	void generateBordereauFile(CoreSession session, DossierExtractionLot lot, File folder) throws ClientException, IOException;
	 ...
	 */
	List<DossierArchivageStatDTO> getDossierArchivageStatResultList(String statutAfter, String dateDebut,
			String dateFin, Long offset,  Long limit, String sortInfos) throws ClientException;
	 ...
	 *            nombre dossier affiché
	 */
	List<DossierArchivageStatDTO> getDossierArchivageStatFullResultList(String statutAfter, String dateDebut,
			String dateFin, String sortInfo) throws ClientException;
}
