...
public class TestChercherCorbeilleEpp {
    ...
    protected static WSEpp getWSEpp(String login, String password) throws Exception {
        WSProxyFactory proxyFactory = new WSProxyFactory(endpoint, BASEPATH, login, password, null);
    ...
    public void chercherCorbeilleGouvernement() throws Exception {
        ...
        ChercherCorbeilleRequest chercherCorbeilleRequest = JaxBHelper.buildRequestFromFile(filename, ChercherCorbeilleRequest.class);
