...
public class NotificationDelegateImpl implements NotificationDelegate {
    ...
    private void traiterNavette(String idEvenement, EvenementType typeEvenement) throws ClientException {
        SolonMgppServiceLocator.getNavetteService().addNavetteToFicheLoi(session, idEvenement, typeEvenement);
    }

    private void updateFicheLoi(String idEvenement, EvenementType typeEvenement) throws ClientException {
        SolonMgppServiceLocator.getDossierService().updateFicheLoi(session, idEvenement, typeEvenement);
    }

    private void accuserReception(String idEvenement, EvenementType evenementType) throws ClientException {
        SolonMgppServiceLocator.getEvenementService().accuserReception(idEvenement, evenementType, session);
    }

	@Override
	public NotifierTableDeReferenceResponse notifierTableDeReference(NotifierTableDeReferenceRequest request) throws ClientException {
