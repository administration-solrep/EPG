...
insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('40',0,10000000,'dépôt rapport - info ministre');
insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('41',0,10000000,'Lettres + décrets');

insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('42',0,10000000,'Lettre intervention extérieure');
insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('43',0,10000000,'Lettre intervention ext en session extra');

insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('44',0,10000000,'Décret congrès article 18C');
insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('45',0,10000000,'Lettres + décrets congrès article 18C');
insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('46',0,10000000,'Décret congrès');
insert into VOC_COURRIER ("id","obsolete","ordering","label") values ('47',0,10000000,'Ampliation congrès');
