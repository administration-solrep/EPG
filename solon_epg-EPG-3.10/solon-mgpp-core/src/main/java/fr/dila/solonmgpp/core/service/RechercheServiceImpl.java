...
public class RechercheServiceImpl implements RechercheService {
	...
	private boolean allowSearch(String menu) {
		return SolonMgppActionConstant.AVIS_NOMINATION.equals(menu)
	...
	@Override
	public RechercherEvenementResponse findMessageWS(final CritereRechercheDTO critereRechercheDTO,
	...
	@Override
	public List<DocumentModel> findDossier(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
			throws ClientException {
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession,
				DossierSolonEpgConstants.DOSSIER_DOCUMENT_TYPE, query.append(rechercheDTO.getWhereClause()).toString(),
	...
	public List<DocumentModel> findOEP(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		final StringBuilder query = new StringBuilder("SELECT d.ecm:uuid as id FROM ");
		query.append(FichePresentationOEP.DOC_TYPE);
		query.append(" as d ");
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationOEP.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findAVI(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationAVI.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	
	@Override
	public List<DocumentModel> findDecret(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
			throws ClientException {
		final RechercheDTO rechercheDTO = QueryBuilder.getInstance().buildQueryDecret(critereRechercheDTO);

		final StringBuilder query = new StringBuilder("SELECT d.ecm:uuid as id FROM ");
		query.append(FichePresentationDecret.DOC_TYPE);
		query.append(" as d ");
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationDecret.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findDOC(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationDOC.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findDPG(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationDPG.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findSD(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationSD.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findJSS(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationJSS.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findAUD(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationAUD.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
	...
	public List<DocumentModel> findDR(final CoreSession coreSession, final CritereRechercheDTO critereRechercheDTO)
		...
		final StringBuilder query = new StringBuilder("SELECT d.ecm:uuid as id FROM ");
		query.append(FichePresentationDR.DOC_TYPE);
		query.append(" as d ");
		...
		return QueryUtils.doUFNXQLQueryAndFetchForDocuments(coreSession, FichePresentationDR.DOC_TYPE,
				query.append(rechercheDTO.getWhereClause()).toString(), rechercheDTO.getParamList().toArray());
	}
