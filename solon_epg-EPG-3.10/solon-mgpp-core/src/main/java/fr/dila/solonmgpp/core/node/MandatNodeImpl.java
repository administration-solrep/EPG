...
public class MandatNodeImpl extends TableReferenceEppNodeImpl implements MandatNode{
  ...
  public MandatNodeImpl(){
	...
	public void remapField(Mandat mandat) {
		...
		setOrdreProtocolaire(mandat.getOrdreProtocolaire() == null ? null : Long.valueOf(mandat.getOrdreProtocolaire()));
		...
		if (mandat.getIdentiteDenormalise() != null) {
			StringBuilder label = new StringBuilder(mandat
					.getIdentiteDenormalise().getCivilite().value())
					.append(" ")
