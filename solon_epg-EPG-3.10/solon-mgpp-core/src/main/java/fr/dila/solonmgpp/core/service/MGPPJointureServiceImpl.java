    ...
    public void registerContribution(Object contribution,String extensionPoint, ComponentInstance contributor){
        if (QUERYASSEMBLER_EP.equals(extensionPoint)) {
            ...
            try {
                ...
                IllegalArgumentException exception  = new IllegalArgumentException("Assembler de classe " + desc.getKlass() + "non trouvé");
                LOGGER.error(null, STLogEnumImpl.FAIL_GET_QUERYASSEMBLER_TEC,exception) ;
                throw exception  ;
            } catch (IllegalAccessException e) {
                IllegalArgumentException exception1  = new  IllegalArgumentException("Problème d'accès à l'assembler de classe " + desc.getKlass());
