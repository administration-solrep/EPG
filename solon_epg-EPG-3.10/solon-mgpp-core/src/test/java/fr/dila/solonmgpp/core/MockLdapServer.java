...
public class MockLdapServer implements ContextProvider {
    // ~ Instance fields
    // ================================================================================================
    private static final STLogger LOGGER = STLogFactory.getLog(MockLdapServer.class);    
    ...
    public MockLdapServer() {
        try {
            ...
            LOGGER.error(null, STLogEnumImpl.FAIL_STARTSUP_AND_CONFIGURES_APACHEDS_TEC,e) ;            
        }
        startLdapServer();
    }
    ...
    public void createGroup(String cn, String ou, String[] memberDns) {
        ...
        try {
            ...
            LOGGER.error(null, STLogEnumImpl.FAIL_CREATE_LDAP_GROUP_TEC,ne) ;            
        }
    }
    ...
    public void createManagerUser() {
        ...
        try {
            ...
            LOGGER.warn(null, STLogEnumImpl.FAIL_CREATE_LDAP_USER_TEC,"Manager user already exists.") ;
        } catch (NamingException ne) {
            LOGGER.error(null, STLogEnumImpl.FAIL_CREATE_LDAP_USER_TEC,ne) ;
        }
    }
    ...
    public void createOu(String name) {
        ...
        try {
            ...
            LOGGER.warn(null, STLogEnumImpl.FAIL_CREATE_LDAP_USER_TEC,"ou " + name + " already exists.") ;
        } catch (NamingException ne) {
            LOGGER.error(null, STLogEnumImpl.FAIL_CREATE_LDAP_USER_TEC,ne) ;            
        }
    }
...
//            schema.createSubcontext("AttributeDefinition/rattachement", attrs);
            ...
            LOGGER.error(null, STLogEnumImpl.FAIL_INIT_LDAP_SCHEMA_TEC) ;
        }
    }
}
