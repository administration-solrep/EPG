...
public final class SolonMgppI18nConstant {
    ...
    public static final String LABEL_SORT_ADOPTION = "label.mgpp.fichedossier.dateAdoption";
    public static final String LABEL_NUMERO_TEXTE_ADOPTE = "label.mgpp.evenement.numeroTexteAdopte";
    public static final String LABEL_DATE_ADOPTION = "label.mgpp.evenement.sortAdoption";
    ...
    public static final Map<String, String> REQUIRED_FIELD_MAP = new HashMap<String, String>();
		static {
			...
			REQUIRED_FIELD_MAP.put("dateLettrePm" ,LABEL_RAPPORT_PARLEMENT);
