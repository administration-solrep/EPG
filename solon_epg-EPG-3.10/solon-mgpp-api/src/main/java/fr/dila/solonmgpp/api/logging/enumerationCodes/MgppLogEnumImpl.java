...
public enum MgppLogEnumImpl implements STLogEnum {
	 ...
	 */
	CANCEL_REPRESENTANT_OEP_TEC(STTypesEnum.CANCEL, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 */
	GET_FICHE_LOI_TEC(STTypesEnum.GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 */
	EMPTY_NOR(STTypesEnum.GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.NOR,
	 ...
	 */
	DEL_REPRESENTANT_OEP_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_OEP,
	 ...
	 */
	DEL_REPRESENTANT_AVI_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_AVI,
	 ...
	 */
	DEL_REPRESENTANT_AUD_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_AUD,
	 ...
	 */
	DEL_FILE_MGPP_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FILE_MGPP,
	 ...
	 */
	DEL_ACT_PARLEMENTAIRE_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.ACT_PARLEMENTAIRE,
	 ...
	 */
	DEL_SEM_PARLEMENTAIRE_TEC(STTypesEnum.DELETE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.SEM_PARLEMENTAIRE,
	 ...
	 */
	FAIL_GET_FICHE_LOI_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 * {@link MgppObjetsEnum#FICHE_LOI}
	 */
	FAIL_DEL_FICHE_LOI_TEC(STTypesEnum.FAIL_DEL, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 * {@link MgppObjetsEnum#FICHE_LOI}
	 */
	FAIL_CREATE_FICHE_LOI_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 * {@link MgppObjetsEnum#FICHE_LOI}
	 */
	FAIL_UPDATE_FICHE_LOI_TEC(STTypesEnum.FAIL_UPDATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 * {@link MgppObjetsEnum#WS_EPP}
	 */
	FAIL_GET_WS_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.WS_EPP,
	 ...
	 */
	FAIL_TRANS_DTO_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.DTO,
	 ...
	 */
	FAIL_GET_MODE_CREATION_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.DTO,
	 ...
	 * {@link MgppObjetsEnum#REPRESENTANT_AVI}
	 */
	FAIL_GET_REPRESENTANT_AVI_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_AVI,
	 ...
	 * {@link MgppObjetsEnum#REPRESENTANT_OEP}
	 */
	FAIL_GET_REPRESENTANT_OEP_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_OEP,
	 ...
	 */
	FAIL_GET_FICHE_PRESENTATION_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_PRESENTATION,
	 ...
	 */
	FAIL_GET_REPRESENTANT_DR_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_DR,
	 ...
	 * {@link MgppObjetsEnum#REPRESENTANT_OEP}
	 */
	FAIL_CREATE_REPRESENTANT_OEP_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_OEP,
	 ...
	 */
	FAIL_GET_MESSAGE_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.MESSAGE,
	 ...
	 */
	FAIL_GET_MIME_TYPE_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, STObjetsEnum.PIECE_JOINTE,
	 ...
	 */
	FAIL_CREATE_PIECE_JOINTE_FROM_BLOB_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, STObjetsEnum.PIECE_JOINTE,
	 ...
	 */
	FAIL_UPDATE_TDR_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.TDR_EPP,
	 ...
	 */
	ANO_OCC_INFO_CORBEILLE_TEC(STTypesEnum.OCCURRENCE_MULTI, STPorteesEnum.TECHNIQUE,
			MgppObjetsEnum.TABLE_MGPP_INFO_CORBEILLE, "Plusieurs occurrences d'info pour une corbeille"),
	 ...
	 */
	FAIL_GET_INFO_CORBEILLE_FONC(STTypesEnum.FAIL_GET, STPorteesEnum.FONCTIONNELLE,
			MgppObjetsEnum.TABLE_MGPP_INFO_CORBEILLE, "Erreur de récupération des informations liées aux corbeilles"),

	/**
	 * Erreur de récup. infos corbeilles {@link STTypesEnum#FAIL_GET}_{@link STPorteesEnum#TECHNIQUE}_
	 * {@link MgppObjetsEnum#TABLE_MGPP_INFO_CORBEILLE}
	 */
	FAIL_GET_INFO_CORBEILLE_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE,
	 ...
	 * {@link MgppObjetsEnum#FICHE_LOI}
	 */
	UPDATE_FICHE_LOI_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 */
	UPDATE_FICHE_PRESENTATION_DR_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.REPRESENTANT_DR,
	 ...
	 */
	UPDATE_FICHE_PRESENTATION_DPG_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE,
			MgppObjetsEnum.DECLARATION_POLITIQUE_GENERALE, "Mise à jour de la fiche de présentation DPG"),
	 ...
	 */
	UPDATE_FICHE_PRESENTATION_SD_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE,
			MgppObjetsEnum.DECLARATION_SUJET_DETERMINE, "Mise à jour de la fiche de présentation SD"),
	 ...
	 */
	UPDATE_FICHE_PRESENTATION_JSS_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE,
			MgppObjetsEnum.DECLARATION_ARTICLE_23_8C, "Mise à jour de la fiche de présentation JSS"),
	 ...
	 */
	UPDATE_FICHE_PRESENTATION_DOC_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE,
			MgppObjetsEnum.DECLARATION_ARTICLE_23_8C, "Mise à jour de la fiche de présentation DOC"),
	 ...
	 * {@link MgppObjetsEnum#TABLE_MGPP_INFO_CORBEILLE}
	 */
	UPDATE_MGPP_INFO_CORB_TEC(STTypesEnum.UPDATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.TABLE_MGPP_INFO_CORBEILLE,
	 ...
	 * {@link MgppObjetsEnum#ACT_PARLEMENTAIRE}
	 */
	CREATE_ACT_PARLEMENTAIRE_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.ACT_PARLEMENTAIRE,
	 ...
	 * {@link MgppObjetsEnum#SEM_PARLEMENTAIRE}
	 */
	CREATE_SEM_PARLEMENTAIRE_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.SEM_PARLEMENTAIRE,
	 ...
	 * {@link MgppObjetsEnum#FICHE_LOI}
	 */
	CREATE_FICHE_LOI_TEC(STTypesEnum.CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FICHE_LOI,
	 ...
	 */
	START_BATCH_PURGE_CALENDAR_TEC(STTypesEnum.INIT, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.CALENDAR,
			"Batch de purge de calendriers - début"),
	/**
	 * END BATCH PURGE CALENDAR : {@link STTypesEnum#END}_{@link STPorteesEnum#TECHNIQUE}_
	 * {@link MgppObjetsEnum#CALENDAR}
	 */
	END_BATCH_PURGE_CALENDAR_TEC(STTypesEnum.END, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.CALENDAR,
	 ...
	 * {@link MgppObjetsEnum#CALENDAR}
	 */
	FAIL_BATCH_PURGE_CALENDAR_TEC(STTypesEnum.FAIL_PROCESS, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.CALENDAR,
	 ...
	 */
	FAIL_BUILD_FOLDER_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.FOLDER_BUILDER,
	 ...
	 */
	FAIL_BUILD_CONTAINER_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.CONTAINER_BUILDER,
	 ...
	 */
	FAIL_BUILD_EVENT_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.EVENT_BUILDER,
	 ...
	 */
	FAIL_BUILD_PIECE_JOINTE_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.PIECE_JOINTE_BUILDER,
	 ...
	 */
	FAIL_CREATE_INSTITUTION_TEC(STTypesEnum.FAIL_CREATE, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.INSTITUTION,
	 ...
	 */
	INIT_MGPP_REQUESTOR_TEC(STTypesEnum.INIT, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.MGPP_REQUESTOR,
	 ...
	 * {@link MgppObjetsEnum#MGPP_REQUESTOR}
	 */
	FAIL_MGPP_REQUESTOR_PROCESS_TEC(STTypesEnum.FAIL_PROCESS, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.MGPP_REQUESTOR,
	 ...
	 * {@link MgppObjetsEnum#MGPP_REQUESTOR}
	 */
	MGPP_REQUESTOR_PROCESS_TEC(STTypesEnum.PROCESS, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.MGPP_REQUESTOR,
			"Requêteur MGPP Info"),
	 ...
	 */
	ACCUSER_RECEPTION_AUTOMATIQUE_TEC(STTypesEnum.DEFAULT, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.NOTIFICATION,
	 ...
	 * {@link MgppObjetsEnum#NOTIFICATION}
	 */
	FAIL_NOTIFY_EVENT_TEC(STTypesEnum.FAIL_NOTIFICATION, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.NOTIFICATION,
	 ...
	 */
	FAIL_GET_DATE_NOTIFICATION_TEC(STTypesEnum.FAIL_GET, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.DATE_NOTIFICATION,
	 ...
	 */
	FAIL_ADD_OEP_PROCESS_TEC(STTypesEnum.FAIL_PROCESS, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.ADD_OEP,
	 ...
	 */
	FAIL_GENERATE_COURRIER_FONC(STTypesEnum.FAIL_GENERATE, STPorteesEnum.FONCTIONNELLE, MgppObjetsEnum.COURRIER,
	 ...
	 */
	INIT_GENERATE_WIDGETS_TEC(STTypesEnum.INIT, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.WIDGET_GENERATOR,
	 ...
	 * {@link MgppObjetsEnum#WIDGET_GENERATOR}
	 */
	FAIL_GENERATE_WIDGETS_TEC(STTypesEnum.FAIL_PROCESS, STPorteesEnum.TECHNIQUE, MgppObjetsEnum.WIDGET_GENERATOR,
