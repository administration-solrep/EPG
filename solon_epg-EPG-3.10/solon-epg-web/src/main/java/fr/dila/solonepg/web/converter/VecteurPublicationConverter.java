 ...
 * 
 */
public class VecteurPublicationConverter extends AbstractConverter {
    
	private static final STLogger LOGGER = STLogFactory.getLog(VecteurPublicationConverter.class);
	
    public VecteurPublicationConverter(){
        // Default constructor
    }
           ...
           List<String> labels =  new ArrayList<String>();
			try {
	           ...
	           for (String id : ids){
	               ...
	               String label = id;
				try {
					label = (String) session.getDocument(new IdRef(idTrimmed)).getPropertyValue("vp:vpIntitule");
