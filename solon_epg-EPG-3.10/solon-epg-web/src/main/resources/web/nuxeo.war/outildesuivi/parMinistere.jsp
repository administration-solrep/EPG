...
$(document).ready(function() {
   //$("#bilanDiv").load("openDocument.jsp?fileName=bilan_semestriels_ministere_tous");
   $.post("openDocument.jsp", {fileName:"bilan_semestriels_ministere_tous",typeLegislature:"<%=legisType%>"}, function(data){$("#bilanDiv").html(data);});
   //$("#delaiDiv").load("openDocument.jsp?fileName=delai_ministere_tous");
   $.post("openDocument.jsp", {fileName:"delai_ministere_tous",typeLegislature:"<%=legisType%>"}, function(data){$("#delaiDiv").html(data);});
