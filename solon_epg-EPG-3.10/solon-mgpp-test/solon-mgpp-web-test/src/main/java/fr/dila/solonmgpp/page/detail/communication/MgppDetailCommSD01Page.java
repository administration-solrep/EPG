...
import fr.dila.solonmgpp.page.create.communication.MgppCreateCommSD01Page;

public class MgppDetailCommSD01Page extends AbstractMgppDetailComm{
    ...
    protected Class<? extends AbstractCreateComm> getModifierResultPageClass() {
      return MgppCreateCommSD01Page.class;
    }
