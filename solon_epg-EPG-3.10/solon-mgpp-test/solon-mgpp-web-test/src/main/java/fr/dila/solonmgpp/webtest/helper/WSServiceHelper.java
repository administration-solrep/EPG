package fr.dila.solonmgpp.webtest.helper;
...
public final class WSServiceHelper {
	...
	public static WSEpp getWSEpp(String login, String password) throws  WSProxyFactoryException {
		WSProxyFactory proxyFactory = new WSProxyFactory(UrlEppHelper.getEndPoint(), UrlEppHelper.BASE_PATH, login, password, null);
