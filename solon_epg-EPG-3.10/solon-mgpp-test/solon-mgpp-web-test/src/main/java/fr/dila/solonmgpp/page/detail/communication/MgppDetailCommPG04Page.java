...
import fr.dila.solonmgpp.page.create.communication.MgppCreateCommPG04Page;

public class MgppDetailCommPG04Page extends AbstractMgppDetailComm{
    ...
    protected Class<? extends AbstractCreateComm> getModifierResultPageClass() {
      return MgppCreateCommPG04Page.class;
    }
