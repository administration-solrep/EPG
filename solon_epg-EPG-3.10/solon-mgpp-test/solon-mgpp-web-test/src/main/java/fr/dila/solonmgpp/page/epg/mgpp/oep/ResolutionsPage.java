...
public class ResolutionsPage extends CommonWebPage {
    ...
    public void addRepresentantAn(final String representant) {
        ...
        waitForPageSourcePartDisplayed(By.id(REPRESENTANT_AN_FUNCTION),18);

        final WebElement elem = getDriver().findElement(By.xpath("//span[@id='nxw_representant_oep_representant_ansuggestDiv']/input"));
        fillField("Représentant", elem, representant);
      
        waitForPageSourcePart(By.xpath("//*[contains(@id,'nxw_representant_oep_representant_an_suggestionBox:suggest')]/tbody/tr[1]/td[2]"), TIMEOUT_IN_SECONDS);
        final WebElement suggest = getDriver().findElement(By.xpath("//*[contains(@id,'nxw_representant_oep_representant_an_suggestionBox:suggest')]/tbody/tr[1]/td[2]"));
        suggest.click();
        waitForPageSourcePart(By.xpath("//*[contains(@id, 'nxw_representant_oep_representant_an_delete')]"), TIMEOUT_IN_SECONDS);
    }
    ...
    public void addRepresentantSenat(final String representant) {
        ...
        final WebElement elem = getDriver().findElement(By.xpath("//span[@id='nxw_representant_oep_representant_sesuggestDiv']/input"));
        fillField("Représentant", elem, representant);
      
        waitForPageSourcePart(By.xpath("//*[contains(@id,'nxw_representant_oep_representant_se_suggestionBox:suggest')]/tbody/tr[1]/td[2]"), TIMEOUT_IN_SECONDS);
        final WebElement suggest = getDriver().findElement(By.xpath("//*[contains(@id,'nxw_representant_oep_representant_se_suggestionBox:suggest')]/tbody/tr[1]/td[2]"));
        suggest.click();
        waitForPageSourcePart(By.xpath("//*[contains(@id, 'nxw_representant_oep_representant_se_delete')]"), TIMEOUT_IN_SECONDS);
    }
