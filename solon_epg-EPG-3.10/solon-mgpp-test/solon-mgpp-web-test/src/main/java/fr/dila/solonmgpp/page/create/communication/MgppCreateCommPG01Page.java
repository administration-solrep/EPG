...
public class MgppCreateCommPG01Page extends AbstractMgppCreateComm {
    ...
    protected Class<? extends AbstractDetailComm> getCreateResultPageClass() {
        return MgppDetailCommPG01Page.class;
    }

    public MgppDetailCommPG01Page createCommPG01(final String objet, final String datePresentation, final String dateLettrePM){
