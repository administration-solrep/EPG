...
public class AjouterAuditionPage extends CommonWebPage {
    
    
    
    public static final String ID_DOSSIER_INPUT = "create_fpaud:nxl_fiche_presentation_aud:nxw_fiche_AUD_idDossier";
    public static final String NOM_ORGANISME_INPUT = "create_fpaud:nxl_fiche_presentation_aud:nxw_fiche_AUD_nomOrganisme";
    public static final String BASE_LEGALE_INPUT = "create_fpaud:nxl_fiche_presentation_aud:nxw_fiche_AUD_baseLegale";
