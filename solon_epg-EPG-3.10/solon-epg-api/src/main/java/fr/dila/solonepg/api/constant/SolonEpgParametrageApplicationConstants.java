...
public final class SolonEpgParametrageApplicationConstants {
     ...
     */
    public static final List<String> PARAMETRAGE_APPLICATION_DEFAULT_ESPACE_TRAITEMENT_COLUMN_LIST = Collections.unmodifiableList(Arrays.asList(new String[] {SolonEpgProfilUtilisateurConstants.NUMERO_NOR_PROPERTY, SolonEpgProfilUtilisateurConstants.TITRE_ACTE_PROPERTY, SolonEpgProfilUtilisateurConstants.DERNIER_CONTRIBUTEUR_PROPERTY, SolonEpgProfilUtilisateurConstants.DATE_ARRIVEE_DOSSIER_LINK_PROPERTY}));
    ...
    public static final String PARAMETRAGE_APPLICATION_DELAI_RAFRAICHISSEMENT_CORBEILLE_PROPERTY = "delaiRafraichissementCorbeille";
