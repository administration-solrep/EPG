...
public interface FeuilleStyleService extends Serializable {
     ...
     */
    File checkFeuilleStyleValidAndTag(File feuilleStyleFile, CoreSession session, boolean isActeIntegral) throws ClientException;
     ...
     */
    String validateFeuilleStyle(File feuilleStyleFile, CoreSession session, boolean isActeIntegral) throws ClientException;
     ...
     */
    Boolean checkFeuilleStyleValid(File feuilleStyleFile, String feuilleStyleName, CoreSession session, boolean isActeIntegral) throws ClientException;
     ...
     */
    String checkFichierParapheurValid(File fichier, String fileName, String documentId, CoreSession session, DocumentModel dossier) throws ClientException;
     ...
     * @throws Exception
     */
    String updateDossierMetadataFromParapheurFile(CoreSession session, InputStream fichierStream, String fileName, DocumentModel repertoireDoc, DocumentModel dossierDoc) throws ClientException;
