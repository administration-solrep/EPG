...
public interface HistoriqueMajMinisterielleService {
	 ...
	 */
	void registerMajDossier(CoreSession session, DocumentModel dossierDoc) throws ClientException;
	 ...
	 * @throws ClientException 
	 */
	void registerMajMesure(CoreSession session, TexteMaitre texteMaitre, MesureApplicative existingMesure, MesureApplicativeDTO updatedMesure) throws ClientException;
	 ...
	 */
	List<MajMin> createDifference(CoreSession session,Dossier dossier,MAJ_TARGET target, List<ComplexeType> initialList, List<ComplexeType> finalList) throws ClientException;
	 ...
	 * @return
	 */
	List<DocumentModel> getHistoriqueMaj(CoreSession session, MAJ_TARGET target) throws ClientException;
	 ...
	 * @return
	 */
	List<Map<String, Serializable>> getHistoriqueMajMap(CoreSession session, MAJ_TARGET target) throws ClientException;
     ...
     * @throws ClientException
     */
	MajMin createMajMinHabilitation(CoreSession session,Dossier oldDossier, Dossier newDossier) throws ClientException;
