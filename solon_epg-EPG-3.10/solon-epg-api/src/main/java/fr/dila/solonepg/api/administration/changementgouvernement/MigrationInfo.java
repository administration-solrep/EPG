...
public class MigrationInfo implements Serializable {
   ...
   */
  protected String typeMigration = VocabularyConstants.POSTE_TYPE;
  ...
  protected String checkElementOrganigrammePresent() {
    ...
    boolean isOrganigrammeElementEmpty = this.isEmpty(oldElementOrganigramme) || this.isEmpty(newElementOrganigramme);
    boolean isMinistereElementEmpty = typeMigration.equals(VocabularyConstants.DIR_TYPE) && (this.isEmpty(oldMinistereElementOrganigramme) || this.isEmpty(newMinistereElementOrganigramme));
  ...
  protected String checkElementOrganigrammeNotEqual() {
    if (oldElementOrganigramme.equals(newElementOrganigramme)) {
      boolean isValide = typeMigration.equals(VocabularyConstants.DIR_TYPE) && !oldMinistereElementOrganigramme.equals(newMinistereElementOrganigramme);
      if (!isValide) {
