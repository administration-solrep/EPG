...
public final class ActiviteNormativeConstants {
	...
	public static final String	TAB_AN_TEXTE_MAITRE									= "TAB_AN_TEXTE_MAITRE";
	public static final String	TAB_AN_TABLEAU_PROGRAMMATION						= "TAB_AN_TABLEAU_PROGRAMMATION";
	public static final String	TAB_AN_TABLEAU_SUIVI								= "TAB_AN_TABLEAU_SUIVI";
	public static final String	TAB_AN_TABLEAU_LOIS									= "TAB_AN_TABLEAU_LOIS";
	public static final String	TAB_AN_TABLEAU_ORDONNANCES							= "TAB_AN_TABLEAU_ORDONNANCES";
	public static final String	TAB_AN_RECHERCHE									= "TAB_AN_RECHERCHE";
	...
	public static final String	ACTIVITE_NORMATIVE_TABLEAU_MAITRE_APP_ORDONNANCES	= "tableau_maitre_application_ordonnances";
	...
	public enum MAJ_TYPE {
		AJOUT, SUPPRESSION, MODIFICATION, MINISTERE, UNKNOW
	};

	public enum MAJ_TARGET {
		ORDONNANCE, TRANSPOSITION, APPLICATION_LOI, HABILITATION, APPLICATION_ORDONNANCE
	};
