...
public class SolonEpgDragAndDropConstants {
	 ...
	 */
	public static final String	ERREUR_TRANSFERT_REPERTOIRE_PLEIN				= "Erreur lors du transfer du fichier. Le répertoire de destination est déjà plein";
	 ...
	 */
	public static final String	ERREUR_NOM_FICHIER								= "Le document ne peut pas être déplacé car il porte le même nom qu'un document existant ou en cours de suppression dans le répertoire de destination. Veuillez renommer le document pour le déplacer.";
	 ...
	 */
	public static final String	ERREUR_REPERTOIRE_IDENTIQUE						= "Le répertoire de provenance et de destination sont identiques. Aucune action effectuée";
	 ...
	 */
	public static final String	DND_COMPATIBILITE_CONVERSION_FDD_VERS_PARAPHEUR	= "DndCompatibiliteConversionFDDVersParapheur";

	/**
	 * Compatibilité avec conversion du parapheur vers le FDD
	 */
	public static final String	DND_COMPATIBILITE_CONVERSION_PARAPHEUR_VERS_FDD	= "DndCompatibiliteConversionParapheurVersFDD";
