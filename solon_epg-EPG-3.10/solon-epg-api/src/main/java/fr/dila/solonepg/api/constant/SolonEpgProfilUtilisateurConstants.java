...
public class SolonEpgProfilUtilisateurConstants {
	...
	public static final String			PROFIL_UTILISATEUR_NOTIFICATION_MESURE_NOMINATIVE_PROPERTY					= "notificationMesureNominative";

	public static final String			PROFIL_UTILISATEUR_NOTIFICATION_MAIL_SI_FRANCHISSEMENT_AUTOMATIQUE_PROPERTY	= "notificationMailSiFranchissementAutomatique";
	...
	public static final String			PROFIL_UTILISATEUR_ID_COLONNE_ESPACE_TRAITEMENT_LIST_PROPERTY				= "idColonneEspaceTraitementVisible";
	...
	public static final String			PROFIL_UTILISATEUR_ID_COLONNE_INSTANCE_FEUILLE_ROUTE_LIST_PROPERTY			= "idColonneInstanceFeuilleRouteVisible";
	...
	public static final String			PROFIL_UTILISATEUR_PRESENCE_LIVE_EDIT										= "presenceLiveEdit";
	 ...
	 */
	public static final List<String>	PARAMETRAGE_APPLICATION_DEFAULT_ESPACE_TRAITEMENT_COLUMN_LIST				= Collections
																															.unmodifiableList(Arrays
																																	.asList(new String[] {
			NUMERO_NOR_PROPERTY, TITRE_ACTE_PROPERTY, DATE_CREATION_DOSSIER_PROPERTY												}));

	/**
	 * Colonnes par défaut affichée pour les utilisateurs dans les instances de feuille de route.
	 */
	public static final List<String>	PARAMETRAGE_APPLICATION_DEFAULT_FEUILLE_ROUTE_COLUMN_LIST					= Collections
																															.unmodifiableList(Arrays
																																	.asList(new String[] {
			FDR_ETAPE_PROPERTY, FDR_MINISTERE_PROPERTY, FDR_POSTE_PROPERTY, FDR_NUM_VERSION_PROPERTY, NOTE_PROPERTY,
			ETAT_PROPERTY, FDR_TYPE_ACTION_PROPERTY, FDR_AUTEUR_PROPERTY, FDR_ECHEANCE_PROPERTY,
			FDR_DATE_TRAITEMENT_PROPERTY, FDR_ETAPE_OBLIGATOIRE_PROPERTY															}));
