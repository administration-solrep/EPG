...
public class SolonEpgContentViewConstant {
	 ...
	 */
	public static final String	RECHERCHE_MODELE_FEUILLE_ROUTE_RESULTAT_CONTENT_VIEW				= "recherche_modele_feuille_route_resultat";

	/**
	 * Content view de la liste des derniers modèles de feuille de route consultés.
	 */
	public static final String	RECHERCHE_RESULTATS_CONSULTES_MODELE_FEUILLE_ROUTE_CONTENT_VIEW		= "recherche_resultats_consultes_modele_feuille_route";

	/**
	 * Content view de la liste des favoris de consultation des modèles de feuille de route.
	 */
	public static final String	RECHERCHE_FAVORIS_CONSULTATION_MODELE_FEUILLE_ROUTE_CONTENT_VIEW	= "recherche_favoris_consultation_modele_feuille_route";
