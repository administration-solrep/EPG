...
public enum FondDeDossierModelType {
    FOND_DOSSIER_FOLDER_UNDELETABLE_ROOT (SolonEpgFondDeDossierConstants.FOND_DOSSIER_FOLDER_UNDELETABLE_ROOT), FOND_DOSSIER_FOLDER_UNDELETABLE (SolonEpgFondDeDossierConstants.FOND_DOSSIER_FOLDER_UNDELETABLE), FOND_DOSSIER_FOLDER_DELETABLE (SolonEpgFondDeDossierConstants.FOND_DOSSIER_FOLDER_DELETABLE);
