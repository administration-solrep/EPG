...
public interface OrdonnanceDTO extends Map<String, Serializable> {
    ...
    DocumentModel remapField(TexteMaitre texteMaitre) throws ClientException;
    ...
    void refresh(Dossier dossier, CoreSession documentManager) throws ClientException;
