...
public class SolonEpgFondDeDossierConstants extends SSFondDeDossierConstants {
	...
	/**
	 * Nom de l'événement qui signale que la racine du modèle de fond de dossier courant a changé
	 */
	public static final String	FOND_DE_DOSSIER_MODEL_ROOT_CHANGED_EVENT				= "FondDeDossierModelRootChangedEvent";
	...
	public static final String	FOND_DE_DOSSIER_FOLDER_NAME_RESERVE_MIN_PORTEUR			= "Répertoire réservé au ministère porteur";

	public static final String	FOND_DE_DOSSIER_FOLDER_NAME_RESERVE_SGG					= "Répertoire réservé au SGG";

	public static final String	FOND_DE_DOSSIER_FOLDER_NAME_RESERVE_MIN_PORTEUR_ET_SGG	= "Répertoire réservé au ministère porteur et au SGG";
	...
	public static final String	FOND_DE_DOSSIER_FOLDER_PATH_EPREUVES					= (new Path("")
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_ALL_USER)
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_EPREUVES))
																								.toString();

	public static final String	FOND_DE_DOSSIER_FOLDER_PATH_DOC_JOINTE					= (new Path("")
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_ALL_USER)
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_DOC_JOINTE))
																								.toString();

	public static final String	FOND_DE_DOSSIER_FOLDER_PATH_RAPPORT_PRESENTATION		= (new Path("")
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_DOC_JOINTE)
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_RAPPORT_PRESENTATION))
																								.toString();

	public static final String	FOND_DE_DOSSIER_FOLDER_PATH_AVIS_CE						= (new Path("")
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_DOC_JOINTE)
																								.append(FOND_DE_DOSSIER_FOLDER_NAME_AVIS_CE))
																								.toString();
