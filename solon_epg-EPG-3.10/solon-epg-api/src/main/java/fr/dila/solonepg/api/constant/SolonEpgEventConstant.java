...
public final class SolonEpgEventConstant {
	 ...
	 * Commentaire lors de la modification d'un fichier du parapheur
	 */
	public static final String	COMMENT_FAIL_GET_FILE_INFO_PARAPHEUR								= "Mise à jour du bordereau non effectué suite à la mauvaise exploitation de la feuille de style ";
	 ...
	 */
	public static final String	DOSSIER_VALIDER_AVEC_CORRECTION_COMMENT_PARAM						= "label.journal.comment.validerAvecCorrection";
	 ...
	 */
	public static final String	DOSSIER_VALIDER_RETOUR_MODIFICATION_COMMENT_PARAM					= "label.journal.comment.validerRetourModification";
	...
	/**
	 * Événement web service "donnerAvisRectificatif"
	 */
	public static final String	WEBSERVICE_AVIS_RECTIFICATIF_EVENT									= "donnerAvisRectificatif";

	/**
	 * Commentaire de l'événement web service "donnerAvisRectificatif"
	 */
	public static final String	WEBSERVICE_AVIS_RECTIFICATIF_COMMENT_PARAM							= "label.journal.comment.donnerAvisRectificatif";
	 ...
	 */
	public static final String	WEBSERVICE_CHERCHER_MODIFICATION_DOSSIER_CE_COMMENT_PARAM			= "label.journal.comment.chercherModificationDossierCe";
	 ...
	 */
	public static final String	WEBSERVICE_ENVOYER_PREMIERE_DEMANDE_COMMENT_PARAM					= "label.journal.comment.envoyerPremiereDemande";
	 ...
	 */
	public static final String	TERMINER_DOSSIER_SANS_PUBLICATION_COMMENT							= "label.journal.comment.terminerDossierSansPublication";
	...
	public static final String	BATCH_EVENT_UPDATE_FICHE_AFTER_UPDATE_BORDEREAU						= "updateFichePresentationAfterUpdateBordereau";

	public static final String	SEND_SEARCH_USERS_RESULTS_EVENT										= "sendSearchUsersResults";
	public static final String	SEND_SEARCH_USERS_RESULTS_USERS_PROPERTY							= "users";
	public static final String	SEND_SEARCH_USERS_RESULTS_IS_ADMIN_PROPERTY							= "isAdmin";
	public static final String	SEND_SEARCH_USERS_RESULTS_IS_ADMIN_MINISTERIEL_PROPERTY				= "isAdminMinisteriel";
	public static final String	SEND_SEARCH_USERS_RESULTS_ADMIN_MINISTERIEL_MINISTERES_PROPERTY 	= "adminMinisterielMinisteres";
	public static final String	SEND_SEARCH_USERS_RESULTS_RECIPIENT_PROPERTY						= "recipient";
	...
	public static final String	CATEGORY_FDD_FOND_DE_DOSSIER_FOLDER_NAME_RESERVE_MIN_PORTEUR_ET_SGG	= "FondDeDossierReserveMinEtSgg";
	...
	public static final String	BATCH_EVENT_DOSSIER_CANDIDAT_ARCHIVAGE_INTERMEDIAIRE				= "dossierCandidatToArchivageIntermediaire";
	public static final String	BATCH_EVENT_DOSSIER_CANDIDAT_ARCHIVAGE_DEFINITIF					= "dossierCandidatToArchivageDefinitive";
	...
	public static final String	BATCH_EVENT_INDEXATION_CONTINUE										= "indexationContinueEvent";
