...
public interface Dossier extends Serializable, STDossier {
	 ...
	 */
	DocumentModel getDossierMetadata(Dossier dossier) throws ClientException;
	...
	/**
	 * Getter publicationIntegraleOuExtrait : "In extenso" ou "Extrait"
	 * 
	 * @return String
	 */
	...
	String getLastChargeMission() throws ClientException, Exception;
