...
public class FavorisRechercheImpl extends STDomainObjectImpl implements FavorisRecherche {
	...
	public boolean isTypeDossier() {
	    return SolonEpgSchemaConstant.FAVORIS_RECHERCHE_TYPE_DOSSIER_VALUE.equals(getType());
	}
	
    @Override
   public boolean isTypeDossierSimple() {
	    return SolonEpgSchemaConstant.FAVORIS_RECHERCHE_TYPE_DOSSIER_SIMPLE_VALUE.equals(getType());
   }
	
	@Override
	public boolean isTypeUser() {
        return SolonEpgSchemaConstant.FAVORIS_RECHERCHE_TYPE_USER_VALUE.equals(getType());
	}
	
	@Override
	public boolean isTypeModeleFeuilleRoute() {
        return SolonEpgSchemaConstant.FAVORIS_RECHERCHE_TYPE_MODELE_FEUILLE_ROUTE_VALUE.equals(getType());
	}
	
	@Override
	public boolean isTypeActiviteNormative() {
        return SolonEpgSchemaConstant.FAVORIS_RECHERCHE_TYPE_ACTIVITE_NORMATIVE_VALUE.equals(getType().split("\\.")[0]);
	}
