...
public class FulltextSubClauseGenerator {
	...
	public String getFullText(String content, List<String> filetypeIds) {
		...
		fulltext.append("(").append(FILE_ECM_FULLTEXT).append(" = \"").append(FullTextUtil.parseContent(content))
				.append("\"").append(getRestriction(filetypeIds)).append(")");
	...
	public String getRechercheExacte(final String content, List<String> filetypeIds) {
		...
		rechercheExacte.append("(").append(FILE_ECM_FULLTEXT).append(" = \"").append(contentCleaned).append("\"")
				.append(getRestriction(filetypeIds)).append(")");
