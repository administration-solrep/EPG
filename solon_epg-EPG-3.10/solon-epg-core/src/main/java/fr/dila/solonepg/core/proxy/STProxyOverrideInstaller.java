...
public class STProxyOverrideInstaller extends DefaultComponent {
	...
	public void activate(ComponentContext context) throws Exception {
		...
		if (!hostnames.isEmpty()) {
			...
			// TODO: s'assurer du chargement du proxy selector avant le client Eurlex
			...
			LOGGER.info(STLogEnumImpl.LOG_INFO_TEC,
					"Configuration du proxy custom pour EUR-Lex: Hostnames='" + hostnames + "', ProxyHost='" + proxyHost
							+ "', ProxyPort='" + proxyPort + "', Protocol='" + protocol + "'");
		} else {
