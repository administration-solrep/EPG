...
public class LoiDeRatificationImpl extends TexteMaitreImpl implements LoiDeRatification {
    ...
    public void setDateLimitePublication(Calendar dateLimitePublication) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.DATE_LIMITE_PUBLICATION, dateLimitePublication);
    }
    ...
    public void setDateExamenCELocked(Boolean dateExamenCELocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.DATE_EXAMEN_CE_LOCKED, dateExamenCELocked);        
    }
    ...
    public void setChambreDepotLocked(Boolean chambreDepotLocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.CHAMBRE_DEPOT_LOCKED, chambreDepotLocked);        
    }
    ...
    public void setNumeroDepotLocked(Boolean numeroDepotLocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.NUMERO_DEPOT_LOCKED, numeroDepotLocked);        
    }
