...
public class ConseilEtatImpl extends STDomainObjectImpl implements ConseilEtat {
	...
	public String getSectionCe() {
		return PropertyUtil.getStringProperty(document, ConseilEtatConstants.CONSEIL_ETAT_SCHEMA,
				ConseilEtatConstants.CONSEIL_ETAT_SECTION_CE_PROPERTY);
	}

	@Override
	public void setSectionCe(String sectionCe) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA, ConseilEtatConstants.CONSEIL_ETAT_SECTION_CE_PROPERTY,
				sectionCe);
	}
	...
	public void setRapporteurCe(String rapporteurCe) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA, ConseilEtatConstants.CONSEIL_ETAT_RAPPORTEUR_CE_PROPERTY,
				rapporteurCe);
	}

	@Override
	public Calendar getDateTransmissionSectionCe() {
		return PropertyUtil.getCalendarProperty(document, ConseilEtatConstants.CONSEIL_ETAT_SCHEMA,
	...
	public void setDateTransmissionSectionCe(Calendar dateTransmissionSectionCe) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA,
				ConseilEtatConstants.CONSEIL_ETAT_DATE_TRANSMISSION_SECTION_CE_PROPERTY, dateTransmissionSectionCe);
	}
	...
	public void setDateSectionCe(Calendar dateSectionCe) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA,
				ConseilEtatConstants.CONSEIL_ETAT_DATE_SECTION_CE_PROPERTY, dateSectionCe);
	}
	...
	public void setDateAgCe(Calendar dateAgCe) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA, ConseilEtatConstants.CONSEIL_ETAT_DATE_AG_CE_PROPERTY,
				dateAgCe);
	}
	...
	public void setNumeroISA(String numeroISA) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA, ConseilEtatConstants.CONSEIL_ETAT_NUMERO_ISA_PROPERTY,
				numeroISA);
	}
	...
	public void setDateSaisineCE(Calendar dateSaisineCE) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA,
				ConseilEtatConstants.CONSEIL_ETAT_DATE_SAISINE_CE_PROPERTY, dateSaisineCE);
	}
	...
	public void setDateSortieCE(Calendar dateSortieCE) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA,
				ConseilEtatConstants.CONSEIL_ETAT_DATE_SORTIE_CE_PROPERTY, dateSortieCE);
	}
	...
	public void setPriorite(String priorite) {
		setProperty(ConseilEtatConstants.CONSEIL_ETAT_SCHEMA, ConseilEtatConstants.CONSEIL_ETAT_PRIORITE_PROPERTY,
				priorite);
	}
