...
public class FeuilleRouteFactory extends SimpleTemplateBasedFactory {
	...
	protected void journaliserCreationElement(DocumentModel eventDoc, final JournalService journalService)
        ...
        journalService.journaliserActionAdministration(session, SolonEpgEventConstant.CREATE_MODELE_FDR_EVENT, comment);
	}

    protected void setDocumentRouteIdOnDefaultInitStep(DocumentModel newChild) throws ClientException {
        STRouteStep step = newChild.getAdapter(STRouteStep.class);
