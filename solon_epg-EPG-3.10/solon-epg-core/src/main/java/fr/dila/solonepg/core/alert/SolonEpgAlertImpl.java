...
public class SolonEpgAlertImpl extends AlertImpl implements SolonEpgAlert {
    ...
    public Calendar getDateDemandeConfirmation() {
        return PropertyUtil.getCalendarProperty(getDocument(), ALERT_SCHEMA, STAlertConstant.ALERT_DATE_DEMANDE_CONFIRMATION);
    }

    @Override
    public void setDateDemandeConfirmation(Calendar dateDemandeConfirmation) {
        PropertyUtil.setProperty(getDocument(), ALERT_SCHEMA,STAlertConstant.ALERT_DATE_DEMANDE_CONFIRMATION, dateDemandeConfirmation);
    }

    @Override
    public Boolean getHasDemandeConfirmation() {
        return PropertyUtil.getBooleanProperty(getDocument(), STAlertConstant.ALERT_SCHEMA, STAlertConstant.ALERT_HAS_DEMANDE_CONFIRMATION);
    }

    @Override
    public void setHasDemandeConfirmation(Boolean hasDemandeConfirmation) {
        PropertyUtil.setProperty(getDocument(), ALERT_SCHEMA,STAlertConstant.ALERT_HAS_DEMANDE_CONFIRMATION, hasDemandeConfirmation);
    }
