...
public class TexteSignaleServiceImpl implements TexteSignaleService {
    ...
    @Override
    public void verser(final CoreSession session, final Dossier dossier, final String type) throws ClientException {
        if (dossier != null) {
    ...
    @Override
    public void retirer(final CoreSession session, final Dossier dossier) throws ClientException {
        // force lock remove
        if (dossier != null) {
    ...
    @Override
    public void save(final CoreSession session, final String idDossier, final Date datePublication, final String vecteurPublication,
            final String observation, final String type) throws ClientException {
    ...
    @Override
    public TexteSignale findTexteSignale(final CoreSession session, final String idDossier, final String type) throws ClientException {
        ...
        final List<DocumentModel> list = QueryUtils.doUFNXQLQueryAndFetchForDocuments(session, TexteSignaleConstants.TEXTE_SIGNALE_DOCUMENT_TYPE,
                FlexibleQueryMaker.KeyCode.UFXNQL.key + queryBuilder.toString(), new Object[] { idDossier });
