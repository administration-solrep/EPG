...
public class DecretImpl extends TexteMaitreImpl implements Decret {
    ...
    public void setNumeroJOPublication(String numeroJOPublication) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.NUMERO_JO_PUBLICATION, numeroJOPublication);
    }

    @Override
    public Boolean isDateSectionCeLocked() {
        return getBooleanProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.DATE_SECTION_CE_LOCKED);
    }

    @Override
    public void setDateSectionCeLocked(Boolean dateSectionCeLocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.DATE_SECTION_CE_LOCKED, dateSectionCeLocked);
    }
    ...
    public void setDateSortieCELocked(Boolean dateSortieCELocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.DATE_SORTIE_CE_LOCKED, dateSortieCELocked);
    }

    @Override
    public Boolean isNumeroJOPublicationLocked() {
        return getBooleanProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.NUMERO_JO_PUBLICATION_LOCKED);
    }

    @Override
    public void setNumeroJOPublicationLocked(Boolean numeroJOPublication) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.NUMERO_JO_PUBLICATION_LOCKED, numeroJOPublication);
    }
    ...
    public void setNumeroPageLocked(Boolean numeroPageLocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.NUMERO_PAGE_LOCKED, numeroPageLocked);
    }
    ...
    public void setRapporteurCeLocked(Boolean rapporteurCeLocked) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.RAPPORTEUR_CE_LOCKED, rapporteurCeLocked);
    }
	...
	public void setOrdonnanceIds(List<String> idsLoiDeRatification) {
		setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.ORDONNANCE_IDS, idsLoiDeRatification);
	}

	@Override
	public String getReferenceDispositionRatification() {
		return getStringProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.REFERENCE_DISPOSITION_RATIFICATION);
	}

	@Override
	public void setReferenceDispositionRatification(String referenceDispositionRatification) {
		setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.REFERENCE_DISPOSITION_RATIFICATION, referenceDispositionRatification);
	}
}
