...
public class DossiersSignalesImpl extends STDomainObjectImpl implements DossiersSignales {
    ...
    public List<String> getDossiersIds() {
        return getListStringProperty(DossierSolonEpgConstants.DOSSIERS_SIGNALES_SCHEMA, DossiersSignales.DOSSIERS_SIGNALES_DOSSIERS_IDS_PROPERTY);
    }

    @Override
    public void setDossiersIds(List<String> dossiersId) {
        setProperty(DossierSolonEpgConstants.DOSSIERS_SIGNALES_SCHEMA, DossiersSignales.DOSSIERS_SIGNALES_DOSSIERS_IDS_PROPERTY, dossiersId);
