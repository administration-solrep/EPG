...
public class DonneesSignataireImpl extends ComplexeTypeImpl implements DonneesSignataire {
    ...
    public DonneesSignataireImpl(Map<String, Serializable> serializableMap) {
        if (serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_ENVOI_SIGNATURE_PROPERTY) instanceof Calendar) {
            this.dateEnvoiSignature = (Calendar) serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_ENVOI_SIGNATURE_PROPERTY);
        }
        if (serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_RETOUR_SIGNATURE_PROPERTY) instanceof Calendar) {
            this.dateRetourSignature = (Calendar) serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_RETOUR_SIGNATURE_PROPERTY);
        }
        if (serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_COMMENTAIRE_SIGNATURE_PROPERTY) instanceof String) {
            this.commentaireSignature = (String) serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_COMMENTAIRE_SIGNATURE_PROPERTY);
        }
    }
    ...
    public void setSerializableMap(final Map<String, Serializable> serializableMap) {
        Serializable dateEnvoiSignature = serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_ENVOI_SIGNATURE_PROPERTY);
        Serializable dateRetourSignature = serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_RETOUR_SIGNATURE_PROPERTY);
        Serializable commentaireSignature = serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_COMMENTAIRE_SIGNATURE_PROPERTY);
        // set the map
    ...
    public String toString() {
        ...
        if (dateEnvoiSignature != null) {
            builder.append(DateUtil.simpleDateFormat("dd/MM/yyyy").format((dateEnvoiSignature).getTime()));
        } else {
            builder.append(" ");
        }
        builder.append(", ");
        ...
        if (dateRetourSignature != null) {
            builder.append(DateUtil.simpleDateFormat("dd/MM/yyyy").format((dateRetourSignature).getTime()));
        } else {
            builder.append(" ");
        }
        builder.append(", ");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj instanceof DonneesSignataireImpl) {
            ...
            if (((this.dateEnvoiSignature == null && donneesSignataire.dateEnvoiSignature == null) || (this.dateEnvoiSignature != null && this.dateEnvoiSignature.equals(donneesSignataire.dateEnvoiSignature))) && ((this.dateRetourSignature == null && donneesSignataire.dateRetourSignature == null) || (this.dateRetourSignature != null && this.dateRetourSignature.equals(donneesSignataire.dateRetourSignature))) && ((this.commentaireSignature == null && donneesSignataire.commentaireSignature == null) || (this.commentaireSignature != null && this.commentaireSignature.equals(donneesSignataire.commentaireSignature)))) {
                resultat = true;
            }
        }
        return resultat;
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(getCommentaireSignature(),
                getDateEnvoiSignature(),
                getDateRetourSignature());
