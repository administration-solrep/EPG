 ...
 * 
 */
public class BirtRefreshFichierAdapterFactory implements DocumentAdapterFactory {

	protected void checkDocument(DocumentModel doc) {
		if (!doc.hasSchema(ActiviteNormativeStatsConstants.BIRT_REFRESH_FICHIER_SCHEMA)) {
