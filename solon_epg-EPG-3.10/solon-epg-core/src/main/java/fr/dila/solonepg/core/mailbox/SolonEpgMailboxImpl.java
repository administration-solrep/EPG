...
public class SolonEpgMailboxImpl extends MailboxImpl implements SolonEpgMailbox {
	...
	public void setCountPourTransmissionAuxAssemblees(Integer count) {
		setProperty(SolonEpgConstant.SOLON_EPG_MAILBOX_SCHEMA, SolonEpgConstant.MAILBOX_POUR_TRANSMISSION_ASSEMBLEES,
				count);
	}
	...
	public void setCountPourRedactionInterfacee(Integer count) {
		setProperty(SolonEpgConstant.SOLON_EPG_MAILBOX_SCHEMA, SolonEpgConstant.MAILBOX_POUR_REDACTION_INTERFACEE,
				count);
	}
}
