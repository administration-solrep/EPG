...
public class ProfilUtilisateurImpl extends STDomainObjectImpl implements ProfilUtilisateur {
	...
	public List<String> getIdsDisplayedColumnsEspaceTraitement() {
		return getListStringProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
	...
	public void setIdsDisplayedColumnsEspaceTraitement(List<String> idsDisplayedColumnsEspaceTraitement) {
		setProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_ID_COLONNE_ESPACE_TRAITEMENT_LIST_PROPERTY,
	...
	public Boolean getNotificationDossierUrgent() {
		return getBooleanProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
	...
	@Override
	public Boolean getPresenceLiveEdit() {
		return getBooleanProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_PRESENCE_LIVE_EDIT);
	}

	@Override
	public void setPresenceLiveEdit(Boolean liveEdit) {
		setProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_PRESENCE_LIVE_EDIT, liveEdit);
	}

	@Override
	public Calendar getDernierChangementMotDePasse() {
		return PropertyUtil.getCalendarProperty(document, SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
	...
	public void setDernierChangementMotDePasse(Calendar dernierChangementMotDePasse) {
		PropertyUtil.setProperty(document, SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				STProfilUtilisateurConstants.PROFIL_UTILISATEUR_DERNIER_CHANGEMENT_MDP_PROPERTY,
	...
	public void setMailSiMajCE(Boolean majCE) {
		setProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_MAIL_SI_MAJ_CE, majCE);
	}

	@Override
	public String getDerniersDossiersIntervention() {
		return getStringProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
	...
	public Integer getNbDossiersVisiblesMax() {
		Object nbDossiersPage = getProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
	...
	public void setNbDossiersVisiblesMax(Integer nbDossierPage) {
		setProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_NB_DOSSIERS_VISIBLES_MAX_PROPERTY, nbDossierPage);
	}

	@Override
	public void setPosteDefaut(Integer idPoste) {
		setProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
				SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_POSTE_DEFAUT, idPoste);
	}

	@Override
	public Integer getPosteDefaut() {
		return (int) (long) getLongProperty(SolonEpgProfilUtilisateurConstants.PROFIL_UTILISATEUR_SCHEMA,
