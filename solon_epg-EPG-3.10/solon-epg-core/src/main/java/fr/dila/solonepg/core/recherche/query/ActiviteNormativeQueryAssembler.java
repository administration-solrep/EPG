	   ...
	   public String getFullQuery(){
		...
		public String getTypeConstraint() {
			if (anEnum == null){
				...
				typeConstraintBuilder.append(PREFIX_DOC_ACTIVITE_NORMATIVE).append(ActiviteNormativeConstants.ACTIVITE_NORMATIVE_SCHEMA_PREFIX).append(":").append(anEnum.getAttributSchema()).append(" = '1'"); 
