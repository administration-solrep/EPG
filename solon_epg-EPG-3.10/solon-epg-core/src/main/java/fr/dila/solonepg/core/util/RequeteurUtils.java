...
public class RequeteurUtils {
     ...
     * 
     */
    public static QueryAssembler getRechercheActiviteNormativeAssembler(ActiviteNormativeEnum anEnum, String whereClause) {
    ...
    public static ActiviteNormativeQueryAssembler getApplicationLoiAssembler(String whereClause) {
        return (ActiviteNormativeQueryAssembler) getRechercheActiviteNormativeAssembler(ActiviteNormativeEnum.APPICATION_DES_LOIS, whereClause);
    }
    ...
    public static String queryApplicationLoi(CoreSession session, String queryPart) {
        return getPatternAN(session, ActiviteNormativeEnum.APPICATION_DES_LOIS, queryPart);
    }
