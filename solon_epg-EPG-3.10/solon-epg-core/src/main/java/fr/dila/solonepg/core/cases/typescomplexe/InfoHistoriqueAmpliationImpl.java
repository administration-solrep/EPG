...
//        }
    ...
    public void setSerializableMap(Map<String, Serializable> serializableMap) {
        Serializable dateEnvoiAmpliation = serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_DATE_ENVOI_AMPLIATION_PROPERTY);
        Serializable ampliationDestinataireMails = serializableMap.get(TraitementPapierConstants.TRAITEMENT_PAPIER_AMPLIATION_DESTINATAIRE_MAILS_PROPERTY);
        //set the map
    ...
    public void setAmpliationDestinataireMails(List<String> ampliationDestinataireMails) {
        ...
        put(TraitementPapierConstants.TRAITEMENT_PAPIER_AMPLIATION_DESTINATAIRE_MAILS_PROPERTY,(Serializable)ampliationDestinataireMails);
    }
}
