...
public class HabilitationImpl extends TexteMaitreImpl implements Habilitation {
    ...
    public void setDatePrevisionnelleCM(Calendar datePrevisionnelleSaisineCM) {
        setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.DATE_PREVISIONNELLE_CM, datePrevisionnelleSaisineCM);
    }
	...
	public void setOrdonnanceIdsInvalidated(List<String> ordonnanceIdsInvalidated) {
		setProperty(TexteMaitreConstants.TEXTE_MAITRE_SCHEMA, TexteMaitreConstants.IDS_INVALIDATED, ordonnanceIdsInvalidated);
	}
}
