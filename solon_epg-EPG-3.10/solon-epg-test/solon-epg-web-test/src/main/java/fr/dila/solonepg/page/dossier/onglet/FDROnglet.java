package fr.dila.solonepg.page.dossier.onglet;
...
public class FDROnglet extends EPGWebPage {
    ...
    private void ajouterEtape1() {
        ...
        selectDestinataireFromOrganigramme(Arrays.asList("document_create:nxl_routing_task_detail:nxw_routing_task_distribution_mailbox_tree:node:0:node:3::min:handle:img:collapsed", "document_create:nxl_routing_task_detail:nxw_routing_task_distribution_mailbox_tree:node:0:node:3:node:0::dir:handle:img:collapsed", "document_create:nxl_routing_task_detail:nxw_routing_task_distribution_mailbox_tree:node:0:node:3:node:0:node:1::nxw_routing_task_distribution_mailbox_addPst"), DESTINATAIRE_ORGANIGRAMME);
