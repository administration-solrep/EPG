...
public class EtapeFeuilleRouteSqueletteDTOImpl
    extends EtapeFeuilleDeRouteDTOImpl
    implements EtapeFeuilleRouteSqueletteDTO {
    ...
    public EtapeFeuilleRouteSqueletteDTOImpl(SSRouteStep routeStep) {
        super(routeStep);
    }
    ...
    public SqueletteStepTypeDestinataire getTypeDestinataire() {
        if (get(SolonEpgSchemaConstant.ROUTING_TASK_TYPE_DESTINATAIRE_PROPERTY) != null) {
            return SqueletteStepTypeDestinataire.valueOf(
                (String) get(SolonEpgSchemaConstant.ROUTING_TASK_TYPE_DESTINATAIRE_PROPERTY)
            );
        }
        return null;
    }
