...
public class AfterValidationPourInformationListener implements PostCommitEventListener {
    ...
    private void handleEvent(final Event event) {
        ...
        final String dossierId = (String) eventProperties.get(
            SolonEpgEventConstant.AFTER_VALIDATION_POUR_INFORMATION_DOSSIER_ID_PARAM
        );
        final String titreActe = (String) eventProperties.get(
            SolonEpgEventConstant.AFTER_VALIDATION_POUR_INFORMATION_DOSSIER_TITRE_ACTE_PARAM
        );
        final String nor = (String) eventProperties.get(
            SolonEpgEventConstant.AFTER_VALIDATION_POUR_INFORMATION_DOSSIER_NOR_PARAM
        );
        final String routeStepMailboxId = (String) eventProperties.get(
