...
public class DetectInconsistentNorListener extends AbstractBatchEventListener {
     ...
     */
    private List<DocumentModel> searchForDossierNorInconsistent(final CoreSession session) {
        ...
        for (final DocumentModel dossierDoc : listDossier) {
            ...
            final String lettresNor = StringUtils.substring(nor, 0, 4);
            final String lettresMin = StringUtils.substring(lettresNor, 0, 3);
            final String lettreDir = StringUtils.substring(lettresNor, 3);
