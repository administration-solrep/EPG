...
public class EpgDossierListingDTOImpl extends AbstractMapDTO implements EpgDossierListingDTO {
    private static final long serialVersionUID = -6369089723223447444L;

    public EpgDossierListingDTOImpl() {
        setFromCaseLink(Boolean.FALSE);
    }

    @Override
    public IdLabel[] getCaseLinkIdsLabels() {
        return (IdLabel[]) get(DossierSolonEpgConstants.CASE_LINK_IDS_LABELS);
    }

    @Override
    public String getDossierId() {
        return getString(DossierSolonEpgConstants.DOSSIER_ID);
    }

    @Override
    public void setCaseLinkIdsLabels(IdLabel[] caseLinkIdsLabels) {
        put(DossierSolonEpgConstants.CASE_LINK_IDS_LABELS, caseLinkIdsLabels);
    }

    @Override
    public void setDossierId(String dossierId) {
        put(DossierSolonEpgConstants.DOSSIER_ID, dossierId);
    }

    @Override
    public String getDocIdForSelection() {
        return getString(DossierSolonEpgConstants.DOC_ID_FOR_SELECTION);
    }

    @Override
    public void setDocIdForSelection(String docIdForSelection) {
        put(DossierSolonEpgConstants.DOC_ID_FOR_SELECTION, docIdForSelection);
    }

    @Override
    public String getType() {
        return DossierSolonEpgConstants.DOSSIER_DOCUMENT_TYPE;
    }

    @Override
    public Boolean isLocked() {
        return getBoolean(DossierSolonEpgConstants.IS_LOCKED);
    }

    @Override
    public void setLocked(Boolean isLocked) {
        put(DossierSolonEpgConstants.IS_LOCKED, isLocked);
    }

    @Override
    public String getLockOwner() {
        return getString(DossierSolonEpgConstants.LOCK_OWNER);
    }

    @Override
    public void setDecretArrive(Boolean isDecretArrive) {
        put(DossierSolonEpgConstants.IS_DECRET_ARRIVE, isDecretArrive);
    }

    @Override
    public Boolean isDecretArrive() {
        return getBoolean(DossierSolonEpgConstants.IS_DECRET_ARRIVE);
    }

    @Override
    public void setLockOwner(String lockOwner) {
        put(DossierSolonEpgConstants.LOCK_OWNER, lockOwner);
    }

    @Override
    public String getCaseLinkId() {
        return getString(DossierSolonEpgConstants.CASE_LINK_ID);
    }

    @Override
    public Boolean getRead() {
        return getBoolean(DossierSolonEpgConstants.IS_READ);
    }

    @Override
    public void setCaseLinkId(String caseLinkId) {
        put(DossierSolonEpgConstants.CASE_LINK_ID, caseLinkId);
    }

    @Override
    public void setRead(Boolean read) {
        put(DossierSolonEpgConstants.IS_READ, read);
    }
    ...
    public Date getDateArrivee() {
        return getDate(DossierSolonEpgConstants.DOSSIER_DATE_ARRIVEE_PROPERTY);
    }

    @Override
    public void setDateArrivee(Date dateArrivee) {
        put(DossierSolonEpgConstants.DOSSIER_DATE_ARRIVEE_PROPERTY, dateArrivee);
    }
    ...
    public String getAuthor() {
        return getString(DossierSolonEpgConstants.DOSSIER_ID_CREATEUR_PROPERTY);
    }

    @Override
    public void setAuthor(String author) {
        put(DossierSolonEpgConstants.DOSSIER_ID_CREATEUR_PROPERTY, author);
    }
    ...
    @Override
    public String getDossierCompletErreur() {
        return getString(DossierSolonEpgConstants.DOSSIER_COMPLET_ERREUR);
    }

    @Override
    public void setDossierCompletErreur(String dossierCompletErreur) {
        put(DossierSolonEpgConstants.DOSSIER_COMPLET_ERREUR, dossierCompletErreur);
    }

    @Override
    public Boolean isRetourPourModification() {
        return getBoolean(DossierSolonEpgConstants.IS_RETOUR_POUR_MODIFICATION);
    }

    @Override
    public void setRetourPourModification(Boolean retourPourModification) {
        put(DossierSolonEpgConstants.IS_RETOUR_POUR_MODIFICATION, retourPourModification);
    }

    @Override
    public void setFromCaseLink(Boolean fromCaseLink) {
        put(DossierSolonEpgConstants.FROM_CASE_LINK, fromCaseLink);
    }

    @Override
    public Boolean isFromCaseLink() {
        return getBoolean(DossierSolonEpgConstants.FROM_CASE_LINK);
    }
    ...
    public String getHabilitationNumeroOrdre() {
        return getString(DossierSolonEpgConstants.DOSSIER_HABILITATION_NUMERO_ORDRE_PROPERTY);
    }

    @Override
    public void setHabilitationNumeroOrdre(String habilitationNumeroOrdre) {
        put(DossierSolonEpgConstants.DOSSIER_HABILITATION_NUMERO_ORDRE_PROPERTY, habilitationNumeroOrdre);
    }
}
