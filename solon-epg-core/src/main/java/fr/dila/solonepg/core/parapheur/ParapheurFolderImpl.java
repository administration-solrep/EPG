...
public class ParapheurFolderImpl extends SSTreeFolderImpl implements ParapheurFolder {
    ...
    public Boolean getEstNonVide() {
        return getBooleanProperty(
            ...
            SolonEpgParapheurConstants.PARAPHEUR_MODEL_FOLDER_EST_NON_VIDE_PROPERTY
        );
    }
    ...
    public Long getNbDocAccepteMax() {
        return getLongProperty(
            SolonEpgParapheurConstants.PARAPHEUR_MODEL_FOLDER_DOCUMENT_SCHEMA,
            SolonEpgParapheurConstants.PARAPHEUR_MODEL_FOLDER_NB_DOC_ACCEPTE_MAX_PROPERTY
        );
    }
    ...
    public Long getNbDocAccepteMaxUnrestricted(CoreSession session) {
        ...
        try {
            nbDocAccepteMax =
                (Long) new UnrestrictedGetOrSetPropertyDocumentRunner(session, document)
                .getProperty(
                        SolonEpgParapheurConstants.PARAPHEUR_MODEL_FOLDER_DOCUMENT_SCHEMA,
                        SolonEpgParapheurConstants.PARAPHEUR_MODEL_FOLDER_NB_DOC_ACCEPTE_MAX_PROPERTY
                    );
        } catch (NuxeoException e) {
            throw new NuxeoException("Erreur lors de de la récupération du nombre maximum de document accepte", e);
        }
    ...
    public List<Map<String, Serializable>> getFeuilleStyleFiles() {
        return getCollectionFileProperty(
            SolonEpgParapheurConstants.PARAPHEUR_MODEL_FOLDER_DOCUMENT_SCHEMA,
    ...
    public List<String> getFormatsAutorisesUnrestricted(CoreSession session) {
        ...
        try {
            ...
            throw new NuxeoException("Erreur lors de de la récupération des formats autorises", e);
        }
