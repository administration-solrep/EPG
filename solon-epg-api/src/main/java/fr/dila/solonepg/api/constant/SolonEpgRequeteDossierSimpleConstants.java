...
public class SolonEpgRequeteDossierSimpleConstants {
    ...
    public static final String REQUETE_DOSSIER_SIMPLE_CRITERES_PRINCIPAUX_SCHEMA =
        "requete_dossier_simple_criteres_principaux";

    public static final String REQUETE_DOSSIER_SIMPLE_CRITERES_SECONDAIRES_SCHEMA =
        "requete_dossier_simple_criteres_secondaires";
