...
public final class SolonEpgBulletinOfficielConstants {
    ...
    public static final String BULLETIN_OFFICIEL_NOR_XPATH = BULLETIN_OFFICIEL_SCHEMA + ":" + BULLETIN_OFFICIEL_NOR;
    public static final String BULLETIN_OFFICIEL_INTITULE = "boIntitule";
    public static final String BULLETIN_OFFICIEL_INTITULE_XPATH =
        BULLETIN_OFFICIEL_SCHEMA + ":" + BULLETIN_OFFICIEL_INTITULE;
