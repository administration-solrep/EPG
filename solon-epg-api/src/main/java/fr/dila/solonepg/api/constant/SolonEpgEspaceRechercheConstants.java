...
public final class SolonEpgEspaceRechercheConstants {
    ...
    public static final String TABLEAU_DYNAMIQUE_SCHEMA_PREFIX = "tabdyn";
    public static final String TABLEAU_DYNAMIQUE_TYPE = "type";
    ...
    public static final String TABLEAU_DYNAMIQUE_DESTINATAIRES_XPATH =
        TABLEAU_DYNAMIQUE_SCHEMA_PREFIX + ":" + TABLEAU_DYNAMIQUE_DESTINATAIRES;
