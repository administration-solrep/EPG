...
public class RequeteurServiceImplTest {
    ...
    public void testSimpleCriteriaSortByPertinence() {
        ...
        criteria.setMinistereAttache(Arrays.asList(new String[] { "Ministère de l’intérieur" }));
        ...
        List<FacetResultEntry> entries = new ArrayList<>(); // searchResults.getFacetEntries(FacetEnum.VECTEUR_PUBLICATION);
        ...
        entries = new ArrayList<>(); //searchResults.getFacetEntries(FacetEnum.CATEGORIE_ACTE);
        ...
        entries = new ArrayList<>(); //searchResults.getFacetEntries(FacetEnum.STATUT);
        ...
        entries = new ArrayList<>(); //searchResults.getFacetEntries(FacetEnum.RESPONSABLE);
    ...
    public void testSimpleCriteriaSortByPublicationDesc() {
        ...
        criteria.setSortType(RechercheLibre.SortType.PUBLICATION_DESC);
