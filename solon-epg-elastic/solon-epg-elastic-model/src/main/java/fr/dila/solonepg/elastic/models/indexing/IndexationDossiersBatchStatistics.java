...
public class IndexationDossiersBatchStatistics {
    private static final ThreadLocal<IndexationDossiersBatchStatistics> statistics = new ThreadLocal<IndexationDossiersBatchStatistics>();
    ...
    public static final void set(IndexationDossiersBatchStatistics s) {
        if (statistics.get() != null) {
            throw new IllegalStateException(
                String.format(
                    "%s déjà positionné sur le thread",
                    IndexationDossiersBatchStatistics.class.getSimpleName()
                )
            );
        }
        statistics.set(s);
