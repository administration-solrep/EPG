...
public class IndexationDossierStatistics {
    private static final ThreadLocal<IndexationDossierStatistics> statistics = new ThreadLocal<IndexationDossierStatistics>();
    ...
    public static final void set(IndexationDossierStatistics s) {
        if (statistics.get() != null) {
            throw new IllegalStateException(
                String.format("%s déjà positionné sur le thread", IndexationDossierStatistics.class.getSimpleName())
            );
        }
        statistics.set(s);
    }
