...
public final class TypeEvenementConstants {
    ...
    public static final String TYPE_EVENEMENT_EVT25 = "EVT25";
    ...
    public static boolean isEvenementPG(String typeEvenement) {
        return (
            typeEvenement != null &&
            (
                typeEvenement.equals(PG01) ||
                typeEvenement.equals(PG02) ||
                typeEvenement.equals(PG03) ||
                typeEvenement.equals(PG04) ||
                typeEvenement.equals(GENERIQUE11) ||
                typeEvenement.equals(FUSION11) ||
                typeEvenement.equals(ALERTE11)
            )
        );
    }
    ...
    public static boolean isEvenementSD(String typeEvenement) {
        return (
            typeEvenement != null &&
            (
                typeEvenement.equals(SD01) ||
                typeEvenement.equals(SD02) ||
                typeEvenement.equals(SD03) ||
                typeEvenement.equals(GENERIQUE11) ||
                typeEvenement.equals(FUSION12) ||
                typeEvenement.equals(GENERIQUE12) ||
                typeEvenement.equals(ALERTE12)
            )
        );
    }
    ...
    public static boolean isEvenementJSS(String typeEvenement) {
        return (
            typeEvenement != null &&
            (
                typeEvenement.equals(JSS01) ||
                typeEvenement.equals(JSS02) ||
                typeEvenement.equals(FUSION13) ||
                typeEvenement.equals(GENERIQUE13) ||
                typeEvenement.equals(ALERTE13)
            )
        );
    }
    ...
    public static boolean isEvenementDOC(String typeEvenement) {
        return (
            typeEvenement != null &&
            (
                typeEvenement.equals(DOC01) ||
                typeEvenement.equals(GENERIQUE15) ||
                typeEvenement.equals(FUSION15) ||
                typeEvenement.equals(ALERTE15)
            )
        );
    }
    ...
    public static boolean isEvenementAUD(String typeEvenement) {
        return (
            typeEvenement != null &&
            (
                typeEvenement.equals(AUD01) ||
                typeEvenement.equals(AUD02) ||
                typeEvenement.equals(GENERIQUE14) ||
                typeEvenement.equals(FUSION14) ||
    ...
    public static boolean isEvenementOEP(String typeEvenement) {
        return (
            typeEvenement != null &&
            (
                typeEvenement.equals(TYPE_EVENEMENT_EVT49_0) ||
                typeEvenement.equals(TYPE_EVENEMENT_EVT49) ||
                typeEvenement.equals(TYPE_EVENEMENT_EVT51)
            )
        );
    }
